...
generated: components: sinks: network_mock: configuration: {
	acknowledgements: {
		description: """
	...
	encoding: {
		...
		type: object: options: {
			...
			should_mezmo_reshape: {
				description: "Should we do custom reshaping for Mezmo sinks?"
				required:    true
				type: bool: {}
			}
			timestamp_format: {
	...
	error_rate: {
		description: "Fraction of requests that return a retriable error (0.0 to 1.0)."
		required:    false
		type: float: default: 0.0
	}
	latency: {
		description: "Latency simulation settings."
		required:    false
		type: object: options: {
			jitter_ms: {
				description: """
			...
			mean_ms: {
				description: "Mean latency in milliseconds per simulated request."
				required:    false
				type: uint: default: 50
			}
		}
	}
	request: {
