...
generated: components: sinks: sumo_logic: configuration: {
	acknowledgements: {
		description: "Acknowlegements option"
		required:    false
	...
	category: {
		required: false
		type: string: default: "mezmo-pipeline"
	}
	compression: {
		description: """
	...
	endpoint: {
		description: "Sumo Logic URL used to send data."
		required:    true
		type: string: {}
	}
	model: {
		description: "The model type to send to Sumo Logic"
		required:    false
		type: string: {
			default: "logs"
			enum: {
				logs:    "Send logs type"
				metrics: "Send metrics type"
			}
		}
	}
	request: {
