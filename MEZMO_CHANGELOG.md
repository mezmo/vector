...
* **vrl**: Bump VRL version (#706) [ba24dba](https://github.com/answerbook/vector/commit/ba24dba1bc1ed99cf186498b15d354f86471f7ff) - GitHub [LOG-22388](https://logdna.atlassian.net/browse/LOG-22388)
...
* ** gcp_chronicle sink**: add content encoding header when compression is enabled (#22009) [26bd3d1](https://github.com/answerbook/vector/commit/26bd3d1b9fa6f3fe23b785ca2b6b205de2839e44) - GitHub
* **auth**: allow users to specify session_name for aws auth (#22206) [720f367](https://github.com/answerbook/vector/commit/720f367fbc444c86a1bfceaaa26c1ef0dda9af26) - GitHub
* **aws_kinesis_firehose source**: correctly parse and store access key (#22629) [709f49d](https://github.com/answerbook/vector/commit/709f49d0518083c08deecffb533d4cb680654253) - GitHub
* **aws_s3 sink**: Respect endpoint_url field in AWS_CONFIG_FILE (#22687) [0c873ec](https://github.com/answerbook/vector/commit/0c873ecd658636a15bcaa82cc6b4c1867bf93cde) - GitHub
* **aws_s3 source**: replace info! with debug! to avoid spam (#22215) [e27ea3a](https://github.com/answerbook/vector/commit/e27ea3a702a5ed31119d718ca3b099186de79303) - GitHub
* **ci**: `prepare.sh` should install the toolchain (#22572) [e1dce44](https://github.com/answerbook/vector/commit/e1dce44355c7dcf0b0d0880111a67f15b997b5d4) - GitHub
* **ci**: add new unmaintained dependency (#22637) [7644658](https://github.com/answerbook/vector/commit/7644658475ffb00358eb0b8658505541661e5944) - GitHub
* **ci**: add zstd decompression to DD metrics E2E tests (#22441) [1200b73](https://github.com/answerbook/vector/commit/1200b739833d058cfc95d63a335069bc076472e9) - GitHub
* **ci**: always run IT suite when in a merge group (#22368) [1c1ded8](https://github.com/answerbook/vector/commit/1c1ded8bf3c564331fd4067878c95386a189bf4c) - GitHub
* **ci**: bandaid for flaky macOS tests (#22239) [681f08d](https://github.com/answerbook/vector/commit/681f08dc027e8b88e032cb86109bf52eff6b7ecf) - GitHub
* **ci**: check for merge_group in check-all job (#22372) [84bc0e4](https://github.com/answerbook/vector/commit/84bc0e4523137692234abe1cf6812ff46382058c) - GitHub
* **ci**: check-all follow-up fix [b90715b](https://github.com/answerbook/vector/commit/b90715bd452e03f4ca151114f5475daca3d99832) - Pavlos Rontidis
* **ci**: deny check fixes (#22627) [fbee731](https://github.com/answerbook/vector/commit/fbee7310b01697a2ce4fff12884d11ae81b473c0) - GitHub
* **ci**: E2E comment triggers (#22443) [490526d](https://github.com/answerbook/vector/commit/490526d2a69f63f91a4d0abdb8d7ef02c4899e66) - GitHub
* **ci**: fix report path (#22351) [3f3428e](https://github.com/answerbook/vector/commit/3f3428e6dac1830364812c64aa9834de1cc30d1e) - GitHub
* **ci**: fix summary paths (#22305) [e382afe](https://github.com/answerbook/vector/commit/e382afe60cc42bbb6855c28cfab59015832e230f) - GitHub
* **ci**: install rust toolchain for macos nightly targets (#22596) [cba85ca](https://github.com/answerbook/vector/commit/cba85ca47704033f6c0001d3f7f807074ab226a4) - GitHub
* **ci**: make some final regression steps optional (#22324) [79852bb](https://github.com/answerbook/vector/commit/79852bbd794338c1ceda3f2c22fcb9eb175f930e) - GitHub
* **ci**: revert to a previous async-nats version  (#22359) [1346acd](https://github.com/answerbook/vector/commit/1346acd3b704c9c84f1445c7396bce023c22fd9c) - GitHub
* **ci**: temporarily ignore failing tests (#22378) [cf40d77](https://github.com/answerbook/vector/commit/cf40d77f79d1ba771b2812822ab009cb7f0516e2) - GitHub
* **cli**: Revert add http sink tls cert/key to `config::watcher` (#22434) [39973ab](https://github.com/answerbook/vector/commit/39973ab03211c234e56983914a816787ae1c520c) - GitHub
* **cli**: vector top is not refreshing (#22748) [5307b3d](https://github.com/answerbook/vector/commit/5307b3dab262bf7283f262c46cee3c3cbfe414fc) - GitHub
* **codecs**: `LengthDelimitedEncoder` fix last message framing  (#22536) [7650fa2](https://github.com/answerbook/vector/commit/7650fa2c8c548e5ef5f22843b456b8297a60ee08) - GitHub
* **deployment**: #22264 add `--no-environment` to systemd service file at `ExecReload` (#22279) [b890bf6](https://github.com/answerbook/vector/commit/b890bf6b7c855cd1970a22f8a28ba9f2872eaaea) - GitHub
* **dev**: make doc generation platform agnostic (#22223) [48fd7ea](https://github.com/answerbook/vector/commit/48fd7ea164009de1f6b302c74574779b0ef85a93) - GitHub
* **dev**: use explicit cast because deranged crate may break compile (#22747) [3ff60f2](https://github.com/answerbook/vector/commit/3ff60f215fe78040dfa418861d094217d6422800) - GitHub
* **enriching**: csv file enrichment tables no longer drop the first row (#22257) [da6886b](https://github.com/answerbook/vector/commit/da6886b5f3578648c2621a1660e0b3b9c51437ca) - GitHub
* **enriching**: fix flush metrics for `memory` enrichment table (#22296) [ffd3597](https://github.com/answerbook/vector/commit/ffd359786b8b1cd6d78d59e29dce3c5c1b276aeb) - GitHub
* **enriching**: prevent panic when attaching inputs to sinks with name of a table (#22528) [6caf5f8](https://github.com/answerbook/vector/commit/6caf5f8a2cbeeb99c0383e46d3a73ff43317c3f2) - GitHub
* **external docs**: Fix wrong links in the guide to Parsing CSV logs with Lua (#22745) [ebb5829](https://github.com/answerbook/vector/commit/ebb582998f716cc32c968cecf1f191482b8cf70e) - GitHub
* **gcp service**: Prevent overflow for gcp token expiry calculation (#22639) [9e8445e](https://github.com/answerbook/vector/commit/9e8445ea8c2852b23a161ae0b69f9f406f4b6eb0) - GitHub
* **host_metrics source**: add defensive check to prevent panics (#22604) [d17c099](https://github.com/answerbook/vector/commit/d17c09948831363646dd9f6d79545cfe82481f11) - GitHub
* **host_metrics source**: use single system instance (#22513) [fe700dc](https://github.com/answerbook/vector/commit/fe700dca4d4ecf0b7802e13e9292852ed5a254a4) - GitHub
* **releasing**: release.rb now fully resolves paths (#22792) [8a06205](https://github.com/answerbook/vector/commit/8a06205f131e0348cd510b3674ab4db327c6040f) - GitHub
* **website**: Remove link checker command from CI commands (#22645) [2fa6f14](https://github.com/answerbook/vector/commit/2fa6f147ccbaa9b97553ecf708ce55edefabb8bb) - GitHub
* **website**: Update permissions and revert id call (#22580) [d0d770f](https://github.com/answerbook/vector/commit/d0d770fbae5106511c1c88852599c82cdfcf32df) - GitHub
* **website**: Update search index for developer guides (#22685) [1c722e6](https://github.com/answerbook/vector/commit/1c722e677e865539f7bdeb68e4dd99283179529f) - GitHub
* **website**: use safe semver version (#22381) [8ee3b2b](https://github.com/answerbook/vector/commit/8ee3b2bfe1d8790cc0c7ba4d1d2db1bd9851fea0) - GitHub


### Chores

* **administration**: update CODEOWNERS for website related PRs (#22647) [522fe02](https://github.com/answerbook/vector/commit/522fe02b17e814bfd8136f4094a38546c7af4bf2) - GitHub
* **ci**: `scripts/environment/Dockerfile` now based on ubuntu-24.04 (#22699) [d5afc84](https://github.com/answerbook/vector/commit/d5afc84c2b5de5955508a2ada3fc62333909ba5f) - GitHub
* **ci**: `ubuntu-20.04` is deprecated - migrate to `ubuntu-24.04` (#22527) [d49c542](https://github.com/answerbook/vector/commit/d49c542930267cc69d577e8d3b86a6c119fcf331) - GitHub
* **ci**: add amqp sink scope [698ef06](https://github.com/answerbook/vector/commit/698ef061349c6586aec94c597b038a92af657cf9) - GitHub
* **ci**: add link to macOS ARM builds (#22144) [b92e285](https://github.com/answerbook/vector/commit/b92e2856422347a65c5744578f8573d2b011ab80) - GitHub
* **ci**: add retries to k8s test job (#22632) [15b28ed](https://github.com/answerbook/vector/commit/15b28ed10b8fd58d59f50bd9f8368b1781edabdf) - GitHub
* **ci**: add the npm package ecosystem for dependabot (#22674) [4762af5](https://github.com/answerbook/vector/commit/4762af5c3ddd670394360504260ca3797cebfa87) - GitHub
* **ci**: Bump aws-actions/configure-aws-credentials from 4.0.2 to 4.0.3 (#22354) [3dbab77](https://github.com/answerbook/vector/commit/3dbab771c26aa2459577a0f70a5a7e67fe936963) - GitHub
* **ci**: Bump aws-actions/configure-aws-credentials from 4.0.3 to 4.1.0 (#22462) [450de36](https://github.com/answerbook/vector/commit/450de36904f3d1524057e8cdb736941194da8d22) - GitHub
* **ci**: Bump bufbuild/buf-setup-action from 1.49.0 to 1.50.0 (#22258) [36f8848](https://github.com/answerbook/vector/commit/36f88481d02333d7cdffce418f39b51d31de48eb) - GitHub
* **ci**: Bump docker/build-push-action from 6.11.0 to 6.12.0 (#22259) [7ee7bf7](https://github.com/answerbook/vector/commit/7ee7bf7362d8abcc375079821a498f6075d85bef) - GitHub
* **ci**: Bump docker/build-push-action from 6.12.0 to 6.13.0 (#22306) [6fa2099](https://github.com/answerbook/vector/commit/6fa2099880417573436e72f8626855266d79d9e3) - GitHub
* **ci**: Bump docker/build-push-action from 6.13.0 to 6.15.0 (#22575) [5ad8b89](https://github.com/answerbook/vector/commit/5ad8b89124a1a11b6d53d6cffa854f62c872cfaf) - GitHub
* **ci**: Bump docker/metadata-action from 5.6.1 to 5.7.0 (#22577) [4fdbe8e](https://github.com/answerbook/vector/commit/4fdbe8e9dc5762388427abad39e7fc3c076c90db) - GitHub
* **ci**: Bump docker/setup-buildx-action from 3.8.0 to 3.9.0 (#22411) [c23095b](https://github.com/answerbook/vector/commit/c23095b17855ab36a3602062a97193d5d38be7c7) - GitHub
* **ci**: Bump docker/setup-buildx-action from 3.9.0 to 3.10.0 (#22576) [e5f1b1d](https://github.com/answerbook/vector/commit/e5f1b1d26a525283e8746a62aaf465141bfeaa9d) - GitHub
* **ci**: Bump docker/setup-qemu-action from 3.3.0 to 3.4.0 (#22412) [f7842e6](https://github.com/answerbook/vector/commit/f7842e6faef7112dc6c7c7d1e6776d728da70241) - GitHub
* **ci**: Bump docker/setup-qemu-action from 3.4.0 to 3.6.0 (#22578) [620ff97](https://github.com/answerbook/vector/commit/620ff9747c66a974b5145eb0d47561cf2b9ac463) - GitHub
* **ci**: Bump ossf/scorecard-action from 2.4.0 to 2.4.1 (#22574) [c6ee08a](https://github.com/answerbook/vector/commit/c6ee08ab33d1833fd0a982517d39af04f6d7944c) - GitHub
* **ci**: delete unused script (#22583) [faab858](https://github.com/answerbook/vector/commit/faab8586d7dad34035bae1f764f6e9882ec504eb) - GitHub
* **ci**: display regression report in summary (#22284) [082a154](https://github.com/answerbook/vector/commit/082a154e69c65166ed52f1a1b44deb9b067069e3) - GitHub
* **ci**: install released wasm-pack version 0.13.1 (#22526) [88ac3e5](https://github.com/answerbook/vector/commit/88ac3e53f2435871e8d39e3dc245a8acbfe80852) - GitHub
* **ci**: integration test suite enhancements (#22237) [394c4e3](https://github.com/answerbook/vector/commit/394c4e37f69bf5920af8f2dd5ebf9a7014eb6772) - GitHub
* **ci**: make Integration Test Suite runnable on Actions (#22356) [f66fe74](https://github.com/answerbook/vector/commit/f66fe74055eace62cba3ce3618dce804d7552861) - GitHub
* **ci**: Mark RUSTSEC-2025-0007 as ignored (#22493) [1519c3e](https://github.com/answerbook/vector/commit/1519c3e5d56b3129db2060f5c88b4126cbbaaa0e) - GitHub
* **ci**: only run integration tests when secrets are available (#22414) [1d65736](https://github.com/answerbook/vector/commit/1d65736e4e39467ec5f320f43b0afc95cd6ad70c) - GitHub
* **ci**: run IT suite when cargo files are modified (#22771) [5ecf5d6](https://github.com/answerbook/vector/commit/5ecf5d6b0a799e2bc2a36c83f38b7ebea481d8b7) - GitHub
* **ci**: smp version: 0.19.3 -> 0.20.1 (#22266) [b03b3b3](https://github.com/answerbook/vector/commit/b03b3b34ce55924a3fbeb88e943da581123a072c) - GitHub
* **ci**: Swap traditional file generator for logrotate_fs for file_to_blackhole test (#22285) [d49cf33](https://github.com/answerbook/vector/commit/d49cf33748ad82292198888687b6b50a01d8500f) - GitHub
* **ci**: Update lading to 0.25.4 (#22271) [604a51b](https://github.com/answerbook/vector/commit/604a51bf7b46e3aa27ebdd278dcbeb5022629e40) - GitHub
* **ci**: update publish-homebrew token (#22502) [9d59440](https://github.com/answerbook/vector/commit/9d59440ba191987ab884360675ee296a1dda335b) - GitHub
* **ci**: update smp to 0.20.2 (#22318) [9f9a573](https://github.com/answerbook/vector/commit/9f9a573fca334c42f92bca7752ca00c458c3e106) - GitHub
* **ci**: update smp to 0.21.0 (#22606) [559d9f2](https://github.com/answerbook/vector/commit/559d9f22dfe8cd2c67a16538ece86dd366566a29) - GitHub
* **ci**: use RELEASE_VERSION for publish step [skip lint] [f3a8eee](https://github.com/answerbook/vector/commit/f3a8eeef3af26c9b0e7def358838564e6c6e4ed2) - Mike Del Tito [LOG-22157](https://logdna.atlassian.net/browse/LOG-22157)
* **deps**: Bump async-nats from 0.33.0 to 0.40.0 (#22759) [8d4c82e](https://github.com/answerbook/vector/commit/8d4c82ed6b5f91d800958dd8f5eab7e13ca585a7) - GitHub
* **deps**: bump async-nats to v0.38 (#22238) [78cb547](https://github.com/answerbook/vector/commit/78cb547daf50b638dd2cae65399c25e52931aa5c) - GitHub
* **deps**: Bump aws-smithy-http from 0.60.12 to 0.61.1 in the aws group (#22620) [b109e5c](https://github.com/answerbook/vector/commit/b109e5c1220bba694ea1c599763296eaafb74798) - GitHub
* **deps**: Bump axios from 1.7.5 to 1.8.2 in /website in the npm_and_yarn group across 1 directory (#22610) [e050e47](https://github.com/answerbook/vector/commit/e050e479b7189e9cc6460ef2678851110612f298) - GitHub
* **deps**: Bump bytes from 1.9.0 to 1.10.0 (#22404) [e36616f](https://github.com/answerbook/vector/commit/e36616f14d7951c908d6e6a3741324de188d9509) - GitHub
* **deps**: Bump bytesize from 1.3.2 to 2.0.1 (#22563) [1dcc0df](https://github.com/answerbook/vector/commit/1dcc0df4e303994d7ff6ea686fc42040cd1224c9) - GitHub
* **deps**: Bump cargo-lock from 10.0.1 to 10.1.0 (#22252) [02d40b9](https://github.com/answerbook/vector/commit/02d40b9f32f7694a6b60073f605adc81d9b9e192) - GitHub
* **deps**: Bump convert_case from 0.6.0 to 0.7.1 (#22249) [dd63177](https://github.com/answerbook/vector/commit/dd63177195eb1a9bc1ff2a434f9bcb7e908d1503) - GitHub
* **deps**: Bump data-encoding from 2.6.0 to 2.7.0 (#22250) [a60b8bb](https://github.com/answerbook/vector/commit/a60b8bb9b84e7f70a2fe58c3b01d79f8542ef91b) - GitHub
* **deps**: Bump data-encoding from 2.7.0 to 2.8.0 (#22402) [b0506a3](https://github.com/answerbook/vector/commit/b0506a336c345638f1ee307505bebac1cdf7a6d9) - GitHub
* **deps**: Bump directories from 5.0.1 to 6.0.0 (#22251) [504a596](https://github.com/answerbook/vector/commit/504a596649b2ff3d0f92bb1c8e2fa0ac06b0af8d) - GitHub
* **deps**: Bump heim from `4925b53` to `f3537d9` (#22399) [b7ae788](https://github.com/answerbook/vector/commit/b7ae78856ed25bc46cd36e7fa5991363d4528c3b) - GitHub
* **deps**: Bump hickory-proto from 0.24.2 to 0.24.3 in the cargo group (#22415) [896be62](https://github.com/answerbook/vector/commit/896be62f6d912f993ec011dc9b392e7cc1faf0ec) - GitHub
* **deps**: Bump indexmap from 2.7.1 to 2.8.0 (#22667) [b79b308](https://github.com/answerbook/vector/commit/b79b30828dfa803b471b1f216b96989e8205abbf) - GitHub
* **deps**: Bump ipnet from 2.10.1 to 2.11.0 (#22254) [91beca7](https://github.com/answerbook/vector/commit/91beca71452c3636c7969f4281cc51cb89338b35) - GitHub
* **deps**: Bump lru from 0.12.5 to 0.13.0 (#22397) [950f15e](https://github.com/answerbook/vector/commit/950f15ea54a5f65f8446143871f206237f175bf7) - GitHub
* **deps**: Bump notify from 7.0.0 to 8.0.0 (#22173) [26421c7](https://github.com/answerbook/vector/commit/26421c7f328c121eed4c9ea0a809b20660d36fcb) - GitHub
* **deps**: Bump ordered-float from 4.5.0 to 4.6.0 (#22174) [acec925](https://github.com/answerbook/vector/commit/acec9259026d4ec35eec66cb621bb686b2c9cf5d) - GitHub
* **deps**: Bump owo-colors from 4.1.0 to 4.2.0 (#22565) [a698327](https://github.com/answerbook/vector/commit/a698327ccce69f13e638f73aa67d47233656f252) - GitHub
* **deps**: Bump proptest from 1.5.0 to 1.6.0 (#22172) [5bf6071](https://github.com/answerbook/vector/commit/5bf6071554ed155817b986e75b8b7c1a2040ef98) - GitHub
* **deps**: bump pulsar@6.3.1 [skip lint] [da3d2d0](https://github.com/answerbook/vector/commit/da3d2d0a8c4bbed93a836bfb97efba695f5aa681) - Mike Del Tito [LOG-22156](https://logdna.atlassian.net/browse/LOG-22156)
* **deps**: Bump rand from 0.8.5 to 0.9.0 (#22403) [6db059e](https://github.com/answerbook/vector/commit/6db059e39ddd4a76f31f7d374138ca0d358c7cb7) - GitHub
* **deps**: Bump rstest from 0.24.0 to 0.25.0 (#22564) [0bc9c58](https://github.com/answerbook/vector/commit/0bc9c58b04a31d40e2f05407a438dcc3e4984779) - GitHub
* **deps**: Bump similar-asserts from 1.6.1 to 1.7.0 (#22562) [09d795a](https://github.com/answerbook/vector/commit/09d795a4c64dc7f4537da738e9e01a960bffddd6) - GitHub
* **deps**: Bump smallvec from 1.13.2 to 1.14.0 (#22452) [b46dbec](https://github.com/answerbook/vector/commit/b46dbece64d53f3e8b6f838e13a75d512be99505) - GitHub
* **deps**: Bump tempfile from 3.15.0 to 3.16.0 (#22400) [d2f216e](https://github.com/answerbook/vector/commit/d2f216efc3ec9def0b3ad3b43ff1527ee0dd7f80) - GitHub
* **deps**: Bump tempfile from 3.16.0 to 3.17.0 (#22450) [db44877](https://github.com/answerbook/vector/commit/db44877a6a48561700c6e44256dfac1e66452c7b) - GitHub
* **deps**: Bump tempfile from 3.17.1 to 3.18.0 (#22623) [5d9c71a](https://github.com/answerbook/vector/commit/5d9c71a3c516f795b976d6d2ba4e8e0320bdd2b1) - GitHub
* **deps**: Bump tempfile from 3.18.0 to 3.19.0 (#22669) [b0cab4f](https://github.com/answerbook/vector/commit/b0cab4fa330d2234063ff648d63e6386dddac489) - GitHub
* **deps**: Bump the aws group across 1 directory with 4 updates (#22766) [43cb82a](https://github.com/answerbook/vector/commit/43cb82a1301dd0c6e115c2958a71be92e49de01c) - GitHub
* **deps**: Bump the aws group with 2 updates (#22245) [2378a21](https://github.com/answerbook/vector/commit/2378a21892adfd259ea8746c3c3ed4da717dce79) - GitHub
* **deps**: Bump the aws group with 2 updates (#22663) [81140cd](https://github.com/answerbook/vector/commit/81140cd76e20ec6022452026867a9c9d89c4caeb) - GitHub
* **deps**: Bump the aws group with 5 updates (#22712) [6a7d9dd](https://github.com/answerbook/vector/commit/6a7d9dd6d646b3ecaeb5b085a777bcc3a6979f91) - GitHub
* **deps**: Bump the azure group with 4 updates (#22621) [0085246](https://github.com/answerbook/vector/commit/00852466425c736ec94b7135f57555a634d96894) - GitHub
* **deps**: Bump the npm_and_yarn group across 1 directory with 2 updates (#22671) [a51cd8d](https://github.com/answerbook/vector/commit/a51cd8d6638a9de7319583b31bba52b026fc6b6a) - GitHub
* **deps**: Bump the patches group across 1 directory with 15 updates (#22497) [e302274](https://github.com/answerbook/vector/commit/e30227456bc2f09bb9537a3c8fc7e086da3aa4ef) - GitHub
* **deps**: Bump the patches group across 1 directory with 19 updates (#22370) [4858750](https://github.com/answerbook/vector/commit/4858750a9282b0089a068aea0ac2c6d4c03aeeca) - GitHub
* **deps**: Bump the patches group across 1 directory with 19 updates (#22628) [0a6c26c](https://github.com/answerbook/vector/commit/0a6c26c3c48030f8ec48f4fa4836abcc0ab8ce78) - GitHub
* **deps**: Bump the patches group across 1 directory with 31 updates (#22190) [7f10bf9](https://github.com/answerbook/vector/commit/7f10bf91c2c1a4cfebbccfe6e5fd10605cecac4c) - GitHub
* **deps**: Bump the patches group across 1 directory with 7 updates (#22672) [0900175](https://github.com/answerbook/vector/commit/090017566704ffba9757ee6a261db1317919e24f) - GitHub
* **deps**: Bump the patches group with 15 updates (#22244) [7eebd94](https://github.com/answerbook/vector/commit/7eebd9471d3cc11b54717253f44ee8487a36bd1e) - GitHub
* **deps**: Bump the patches group with 3 updates (#22393) [9d67c79](https://github.com/answerbook/vector/commit/9d67c79724b65c2d31e136c3100d5b950eb3db69) - GitHub
* **deps**: Bump the patches group with 7 updates (#22551) [9fd7761](https://github.com/answerbook/vector/commit/9fd77616b687c7a49472a6b95eecc26eae69fb7d) - GitHub
* **deps**: Bump the patches group with 7 updates (#22753) [645989d](https://github.com/answerbook/vector/commit/645989dc42dbe6c667107f5c138c51246b05fc2c) - GitHub
* **deps**: Bump the patches group with 8 updates (#22711) [f095e15](https://github.com/answerbook/vector/commit/f095e154a8b47c32685a3a25722de9dffcf90fc4) - GitHub
* **deps**: Bump tokio from 1.43.0 to 1.44.0 (#22625) [055fde6](https://github.com/answerbook/vector/commit/055fde6967fd5d3be0d1ee4b413e4cf279399560) - GitHub
* **deps**: Bump uuid from 1.11.1 to 1.12.0 (#22253) [c0830fd](https://github.com/answerbook/vector/commit/c0830fd72f7118540d807a1bd62802e9b8c7c6b5) - GitHub
* **deps**: Bump uuid from 1.12.0 to 1.15.1 (#22561) [07f7562](https://github.com/answerbook/vector/commit/07f75629710746cb94a711401dd259b2eb5dc471) - GitHub
* **deps**: Bump uuid from 1.15.1 to 1.16.0 (#22666) [b23feb3](https://github.com/answerbook/vector/commit/b23feb371d2a99428b32f693ff0830a4aff09dcc) - GitHub
* **deps**: Bump vrl from `2ccb98e` to `7612a8b` (#22401) [3a82b88](https://github.com/answerbook/vector/commit/3a82b88280eddde6f7193f38bc65dbd0fc298629) - GitHub
* **deps**: Bump vrl from `2d5e2df` (edited by pront) (#22668) [61d545b](https://github.com/answerbook/vector/commit/61d545b263170383f352ec7c8bc6667aa167f984) - GitHub
* **deps**: Bump vrl from `7612a8b` to `acfd9f9` (#22453) [a96a970](https://github.com/answerbook/vector/commit/a96a97009f36387d11031e0553e1a41e5d184689) - GitHub
* **deps**: Bump vrl from `c0245e1` to `2ccb98e` (#22303) [559cb46](https://github.com/answerbook/vector/commit/559cb4667f43cca891189b7179e0f37c778d5c49) - GitHub
* **deps**: update `hickory_proto` to 0.25.0 (#21759) [6bc5dce](https://github.com/answerbook/vector/commit/6bc5dce33a3ac898e5dea45f90674ac77c83e160) - GitHub
* **deps**: update Cargo.lock (#22214) [bbaa34c](https://github.com/answerbook/vector/commit/bbaa34c6cbd06848e24399b442b451f5e95796bc) - GitHub
* **deps**: update openssl related crates (#22352) [ff77761](https://github.com/answerbook/vector/commit/ff77761e2c305f0b0904295654d30f73a039a75c) - GitHub
* **deps**: Update ring (#22511) [d19ac2a](https://github.com/answerbook/vector/commit/d19ac2a6226cb4220df9a6a70714a51c8dde4ff9) - GitHub
* **dev**: bump bitflags (#22283) [21776bb](https://github.com/answerbook/vector/commit/21776bbd15113e34841dc6269358fc69b9166546) - GitHub
* **dev**: cargo update -p vrl (#22591) [5b7c485](https://github.com/answerbook/vector/commit/5b7c485e290a57142bca2925b9a42ad4e1c2c4dd) - GitHub
* **dev**: fix `vdev check scripts` warnings (#22277) [9161ca7](https://github.com/answerbook/vector/commit/9161ca75417db37fad78848d31ca2a586321c2b2) - GitHub
* **dev**: fix bug.yml [70d3e63](https://github.com/answerbook/vector/commit/70d3e630736bbf25c6d9e24fb0e21a67b6210a33) - GitHub
* **dev**: fix CVE-2024-47614 by bumping async-graphql (#22371) [f71ba42](https://github.com/answerbook/vector/commit/f71ba42bf384371ea97ea74bf71f139da12e0335) - GitHub
* **dev**: fix markdown lint failures (#22219) [14b630f](https://github.com/answerbook/vector/commit/14b630fca53ef5f7f2bab49e5a081b7d30dd61b9) - GitHub
* **dev**: fix protoc installation script for macOS arm64 (#22221) [ca73a06](https://github.com/answerbook/vector/commit/ca73a067a3a16bf6aeac0e06f51322efdd126476) - GitHub
* **dev**: populated the new github 'type' field for features (#22315) [1af287f](https://github.com/answerbook/vector/commit/1af287f1f05050e0382d3dac6efb888508dce390) - GitHub
* **dev**: PR template enhancements (#22779) [89008b6](https://github.com/answerbook/vector/commit/89008b6efe89a9dbe25bb1d4a4b26c4e2c1b7a9f) - GitHub
* **dev**: replace plork images (#22217) [8e15aeb](https://github.com/answerbook/vector/commit/8e15aebcb1cea013a29f6e747026a58a416a69bb) - GitHub
* **dev**: switch to Rust 1.85 (#22525) [e686aea](https://github.com/answerbook/vector/commit/e686aeaad592b46c07a55fe88c69f43e3b4f2a5f) - GitHub
* **dev**: Update bug.yml to test new issue type field [89366e9](https://github.com/answerbook/vector/commit/89366e97c3c8d7c645d250749b58a2f6edfbd4bc) - GitHub
* **dev**: use build licenses instead of running the tool directly (#22795) [992213e](https://github.com/answerbook/vector/commit/992213ec59e7110ceb7aedcaf2e7614ff2cc853d) - GitHub
* **dnstap source**: update dnstap protobuf schema (#22348) [59ff175](https://github.com/answerbook/vector/commit/59ff175a514be619437113fc4ef3e80304415d33) - GitHub
* **external docs**: generate global option configuration automatically from Rust code (#22345) [9593581](https://github.com/answerbook/vector/commit/9593581f775d7132bcf697605e738a90c9d046aa) - GitHub
* **external docs**: Remove redundant loop in expand schema references (#22508) [b362704](https://github.com/answerbook/vector/commit/b362704a4fb7bcaa90414c4e44c1b66c77e177a3) - GitHub
* **host_metrics source**: ignore flakey tcp metrics tests (#22544) [3cf1ecc](https://github.com/answerbook/vector/commit/3cf1eccc8dc5cf508a80fa47a251236862221f4c) - GitHub
* **kubernetes platform**: Update kustomization.yaml (#22776) [ea1cb23](https://github.com/answerbook/vector/commit/ea1cb23d789a0c17aa109a0b7afb986a6aa3c875) - GitHub
* **performance**: Enable simdutf8 feature for maxminddb (#22456) [0e21450](https://github.com/answerbook/vector/commit/0e214505f9f532078ea9fc6d45af78a94c24a3e7) - GitHub
* **releasing**: add basic oci labels (#22546) [6fe2317](https://github.com/answerbook/vector/commit/6fe2317d0b1bbc477fafd9ff80f39de55d36dffc) - GitHub
* **releasing**: add debug statements (#22796) [34328b3](https://github.com/answerbook/vector/commit/34328b354585eb35938c28e0f5e45df5922339a8) - GitHub
* **releasing**: add known issue for 0.44.0 (#22226) [aaa54ec](https://github.com/answerbook/vector/commit/aaa54ec9bb3052bd676f8baa2fb8d97324533c30) - GitHub
* **releasing**: automate more pre-release steps (#22614) [f4c6835](https://github.com/answerbook/vector/commit/f4c6835a3032c810e005dc986a6c88849d3b30e0) - GitHub
* **releasing**: automate release preperation steps (part 1) (#22485) [92f09ee](https://github.com/answerbook/vector/commit/92f09ee495e57bb9ee82813abc043fd97e5de414) - GitHub
* **releasing**: automate the rest of the release prep steps (#22688) [63db035](https://github.com/answerbook/vector/commit/63db03579d786d2d82e58e1b1a78f4a8e1304586) - GitHub
* **releasing**: cargo vdev build manifests (#22201) [aaa90cb](https://github.com/answerbook/vector/commit/aaa90cbdf133cf9a21374ab7008036c6c664a22f) - GitHub
* **releasing**: cargo vdev build manifests (#22505) [4854f06](https://github.com/answerbook/vector/commit/4854f060ce1c80f703f2061dd8a1a09ee3c3275b) - GitHub
* **releasing**: cherry picking 0.44.0 commits (#22207) [e28d6e8](https://github.com/answerbook/vector/commit/e28d6e8d6514c990009c254f3e16b358478651bb) - GitHub
* **releasing**: Complete v0.45.0 release (#22506) [8a55813](https://github.com/answerbook/vector/commit/8a55813266aa2b2ea64e96f6fc9d7e9a213a8991) - GitHub
* **releasing**: prepare v0.46.1 (#22870) [9a19e8a](https://github.com/answerbook/vector/commit/9a19e8a70bfcce38a029add144f53bdb8cebcf8b) - GitHub
* **releasing**: release prep  (#22835) [5b4e0c9](https://github.com/answerbook/vector/commit/5b4e0c94a0fe97cd9aa8e1229c53984ee666d570) - GitHub
* **releasing**: repo root fixes (#22797) [4cda798](https://github.com/answerbook/vector/commit/4cda79849ec5a3424e7c7857141dccdd54e2b312) - GitHub
* **releasing**: tweak release templates (#22202) [a0b4e0a](https://github.com/answerbook/vector/commit/a0b4e0ab7048cad723aeca94d7c747724adf4fe3) - GitHub
* **releasing**: vdev perpare fixes (#22790) [fef395d](https://github.com/answerbook/vector/commit/fef395dba603cd5a24083bcdff702509efb940dd) - GitHub
* **releasing**: vdev prepare add before commit (#22798) [1301b96](https://github.com/answerbook/vector/commit/1301b96e5e0fd9c7f76a1a27c8f43f2abd2e8a65) - GitHub
* **releasing**: vdev prepare refactoring (#22791) [8d5c996](https://github.com/answerbook/vector/commit/8d5c996b290d96d4d1a1cb033078fa0fdb86b0d6) - GitHub
* **releasing**: vdev prepare tweaks (#22794) [d8c5e0c](https://github.com/answerbook/vector/commit/d8c5e0cc521bfd15882ff38116810f43d617f09b) - GitHub
* **sinks**: Allow S3Sink builder to accept a type that implements Partitioner (#22658) [c37f0a8](https://github.com/answerbook/vector/commit/c37f0a87ab305cda544d37e8c7fa6763e13b9cf5) - GitHub
* **vector source**: Revert add `headers` option" (#22741) [8bc821f](https://github.com/answerbook/vector/commit/8bc821f992207e2f6b5372cb7e9fc17aed0de62b) - GitHub
* **vrl**: use `as_str()` as implemented by `Value`  (#22416) [c231196](https://github.com/answerbook/vector/commit/c23119676042a7964bf19a0b8ac2e4ade5624a36) - GitHub
* **website**: add notice on timestamp field renaming in the Elasticsearch sink, when use data_stream mode (#22196) [0df7c48](https://github.com/answerbook/vector/commit/0df7c486e7c7251da200167d55f6dbbc1910e6fb) - GitHub
* **website**: fix enrichment table link (#22646) [c17746d](https://github.com/answerbook/vector/commit/c17746def3891ff4d7b69e2cfa5bbb6c484e4565) - GitHub
* **website**: tweaks to highlights blog post (#22512) [e99bf9e](https://github.com/answerbook/vector/commit/e99bf9e5bae9ba5d86f3503bb664688674be1f14) - GitHub
* **website**: Update `typesense-sync` depedency, search config (#22707) [48348ff](https://github.com/answerbook/vector/commit/48348ff1f0517566e6dd228ae96d1649066a925e) - GitHub
* **website**: Update if statement for preview trigger (#22673) [3e0c157](https://github.com/answerbook/vector/commit/3e0c157f3091ac4c3660a5f24749dd7fd0c7a277) - GitHub
* **website**: Update workflow from bash to gh scripts (#22503) [da67459](https://github.com/answerbook/vector/commit/da674594f9fcc41b288c5ae2679fae1dc9e3ad74) - GitHub
* **website**: WEB-5803 | Remove netifly references from Privacy markdown (#22598) [207e5d4](https://github.com/answerbook/vector/commit/207e5d47b48f532671d2858cd898674d0d30a517) - GitHub


### Features

* **aws_s3 source**: Support vhost-style S3 bucket addressing (#22475) [e3653c3](https://github.com/answerbook/vector/commit/e3653c38f6a2f66d9108d16814b68003aaa0631a) - GitHub
* **ci**: publish build images to the GitHub Container Registry (#22694) [56fd462](https://github.com/answerbook/vector/commit/56fd46215cc2080651fa3dc466b6fc8cebd75e50) - GitHub
* **ci**: refactor and parallelize integration-tests (CI review) (#22380) [22ee402](https://github.com/answerbook/vector/commit/22ee402ad82118634cb46e84aca8cef3755fb87d) - GitHub
* **ci**: run integration tests in parallel (#22205) [d599ec0](https://github.com/answerbook/vector/commit/d599ec002692e6a206750d187bfa32ea66dd29d3) - GitHub
* **cli**: Add `--components` option in `vector top` to filter out components (#22392) [aadfa18](https://github.com/answerbook/vector/commit/aadfa189a8899311e33dfc632ccffa9e2789fe4e) - GitHub
* **cli**: Add http sink tls cert/key to `config::watcher` (#22386) [e84e0bf](https://github.com/answerbook/vector/commit/e84e0bf2abc2cc55479ae39dc176f46dc68b929d) - GitHub
* **cli**: Handle reload based on referenced file change (#22539) [5e392ad](https://github.com/answerbook/vector/commit/5e392ade8d2080d136b32d02992534190b985668) - GitHub
* **datadog service**: support filtering on ddtags and ddsource in datadog search syntax (#22281) [cbcbeb3](https://github.com/answerbook/vector/commit/cbcbeb3f36fb22efc7ff856bc967b82ebda641ef) - GitHub
* **dev**: add config IDE autocompletion guide  (#22329) [f09af60](https://github.com/answerbook/vector/commit/f09af60af4d76516a065ef9483c8cc525450d028) - GitHub
* **enriching**: add `memory` enrichment table (#21348) [318930b](https://github.com/answerbook/vector/commit/318930b819872ce12c23bbee8475aafda1deeedb) - GitHub
* **enriching**: run memory enrichment table as a source too (#22466) [3c073f9](https://github.com/answerbook/vector/commit/3c073f9bf91ff36a308f5edb988e657ed753a551) - GitHub
* **gcp_stackdriver_logs sink**: Support additional top level labels for gcp_stackdriver_logs sink (#22473) [baffdbf](https://github.com/answerbook/vector/commit/baffdbfd8bda0ca3beae4fec38c35a748176ed29) - GitHub
* **host_metrics source**: add a new collector for tcp stats (#22057) [2d7cbd8](https://github.com/answerbook/vector/commit/2d7cbd88e5a6b408c540df2516d414215a354796) - GitHub
* **host_metrics source**: Add process virtual memory metric (#22183) [c68bd7a](https://github.com/answerbook/vector/commit/c68bd7af375797c0e4e9f5d94dd2e0c082babe5c) - GitHub
* **internal**: Make fields in HumioLogsConfig public (#22421) [530c4d1](https://github.com/answerbook/vector/commit/530c4d183658d64deb1ad91f51b9fb96c41aae27) - GitHub
* **metrics**: separate `expire_metrics_secs` configuration per metric set (#22409) [9a0afba](https://github.com/answerbook/vector/commit/9a0afba675b84a3e8f0b77a80532a10e763237d6) - GitHub
* **new sink**: initial `websocket_server` sink (#22213) [78adec7](https://github.com/answerbook/vector/commit/78adec73b3ddc6fe403b59ea1a81780649cd059b) - GitHub
* **new sink**: Keep sink (#22072) [fd515ea](https://github.com/answerbook/vector/commit/fd515ea86e3a3378c69953a4a59556045eb93fe4) - GitHub
* **postgres sink**: Add postgres sink (#21248) [5e34f9b](https://github.com/answerbook/vector/commit/5e34f9b4f569a819072e73785830247caabd09ce) - GitHub
* **pulsar sink**: support tls options (#22148) [b4aaaa8](https://github.com/answerbook/vector/commit/b4aaaa88fe96ef23d3e8c4e40a8c2045aa9f56c5) - GitHub
* **releasing**: refactor homebrew.rs to support ARM builds (#22156) [b77e6c1](https://github.com/answerbook/vector/commit/b77e6c17cdc4416fc12a2a9c8aa3ff0cfeaf97a3) - GitHub
* **sample transform**: Sample by percent rate (#22727) [0be4137](https://github.com/answerbook/vector/commit/0be41370135167ec75278db09b5729c0003af1f2) - GitHub
* **sources**: add custom auth strategy for components with HTTP server (#22236) [64c56ed](https://github.com/answerbook/vector/commit/64c56ed302502bae1e0f5fa29608a3616d7e90e5) - GitHub
* **tag_cardinality_limit transform**: enable per metric limits for `tag_cardinality_limit` (#22077) [47e348c](https://github.com/answerbook/vector/commit/47e348cc8cab3bcbd8d6cf6937f9d0e2e329e080) - GitHub
* **websocket_server sink**: add message buffering for `websocket_server` (#22479) [8937349](https://github.com/answerbook/vector/commit/8937349d551e4b59e5758fd97a649f37bb6c8721) - GitHub
* **websocket_server sink**: add simple customizable extra metrics tags for `websocket_server` (#22484) [a6d3add](https://github.com/answerbook/vector/commit/a6d3addd61587372bcc65ac0e0ae6a05614a7a13) - GitHub


### Miscellaneous

* Merge pull request #695 from answerbook/feature/LOG-22157 [2997a29](https://github.com/answerbook/vector/commit/2997a29be60a15062e66f4a95afa6a506fb30ada) - GitHub [LOG-22157](https://logdna.atlassian.net/browse/LOG-22157) [LOG-22157](https://logdna.atlassian.net/browse/LOG-22157)
* Merge tag 'v0.46.1' into feature/LOG-22157 [skip lint] [5d79a9d](https://github.com/answerbook/vector/commit/5d79a9da1d91e86d8f161c68acedd39cf88e14c5) - Mike Del Tito [LOG-22157](https://logdna.atlassian.net/browse/LOG-22157) [LOG-22157](https://logdna.atlassian.net/browse/LOG-22157)
* Revert "chore(deps): Bump async-nats from 0.33.0 to 0.40.0" (#22772) [6bd4cf1](https://github.com/answerbook/vector/commit/6bd4cf194a98ac4d80c7083db0b136194d8a1a9a) - GitHub
* add debugging statement [cb09d9a](https://github.com/answerbook/vector/commit/cb09d9a0cd73e3deb53bd440cd2e6b1e648c377a) - Pavlos Rontidis
* feat (sink: aws_cloudwatch_logs) #11185: Allow specifying a KMS key and tags for newly created AWS CloudWatch log groups. (#22274) [f151cab](https://github.com/answerbook/vector/commit/f151cab1fa156a53b6b44db245deedad8eef6ab8) - GitHub
* **external docs**: fix missing configuration section for `websocket_server` docs (#22480) [ae84bcd](https://github.com/answerbook/vector/commit/ae84bcd9de4b9a47f4b760c6451d1aea11baa438) - GitHub
* **external**: add `how_it_works` section for auth config (#22483) [aa43a16](https://github.com/answerbook/vector/commit/aa43a1674cfbeb2e94ac31196a1dade34dc24b75) - GitHub
* **external**: add docs for `shannon_entropy` function (#22428) [bd06afc](https://github.com/answerbook/vector/commit/bd06afcc6d2df680b3ef42a6873dfba5ab0b27be) - GitHub
* **external**: add missing Quad9 credits in changelog entries (#22568) [30995ea](https://github.com/answerbook/vector/commit/30995ea87315acaf57b6f1dcfe8ffd1462d104b3) - GitHub
* **external**: add missing Quad9 credits in previous releases (#22569) [d39ca73](https://github.com/answerbook/vector/commit/d39ca7386d98fbf914da6aa71406015bcfc38460) - GitHub
* **external**: add note for input/output typs in remap docs (#22435) [e878c89](https://github.com/answerbook/vector/commit/e878c892c14607a651732a93d428ef029e072713) - GitHub
* **external**: Adds example log payload Vector ships OTEL Collector (#22225) [543e609](https://github.com/answerbook/vector/commit/543e609036078a6882a1a4fe4bb11484805bf10d) - GitHub
* **external**: Clarify Homebrew support documentation (#22684) [a3d1f7b](https://github.com/answerbook/vector/commit/a3d1f7b382e61f12c5a16bf948435d5095c3a024) - GitHub
* **external**: document 'open_files' metric (#22676) [f567461](https://github.com/answerbook/vector/commit/f5674617ad5d14186a092e379b8712bb9b8918ae) - GitHub
* **external**: documentation fixes for style consistency (#22200) [025ac6c](https://github.com/answerbook/vector/commit/025ac6cf85e82ddfd315a6122e06bb672ce778d5) - GitHub
* **external**: fix 'parse-groks' VRL doc (#22194) [64735f3](https://github.com/answerbook/vector/commit/64735f31bfd9367af3db4cd761fb6c40e7f3b9eb) - GitHub
* **external**: fix `enrichment_table` and `secret` docs (#22319) [0431a07](https://github.com/answerbook/vector/commit/0431a079273432e69cb5a1fe9add9c85ca4e1edc) - GitHub
* **external**: fix DD agent docs (#22731) [1b2a413](https://github.com/answerbook/vector/commit/1b2a413a462c17c8c125c0172e97b76292d8d211) - GitHub
* **external**: fix getting starting guide rendering (#22332) [acd7dd2](https://github.com/answerbook/vector/commit/acd7dd25d1192b344285c73a1541b42909d1af7d) - GitHub
* **external**: fix is_nullish docs (#22765) [e7c4995](https://github.com/answerbook/vector/commit/e7c4995c482fe854fae3132f47f81ae00d869282) - GitHub
* **external**: fix OpenTelemetry Sink Quickstart to match expected log data model (#22222) [110c883](https://github.com/answerbook/vector/commit/110c883cf60d4f1ac87a5a952697fd7d966bd9d6) - GitHub
* **external**: fix typo in csv enrichment guide (#22652) [c9d5b90](https://github.com/answerbook/vector/commit/c9d5b907c2dd30c60d18e6d21648632ce9b4477a) - GitHub
* **external**: fix wording in common sinks components docs (#22317) [d1e3dda](https://github.com/answerbook/vector/commit/d1e3dda4c4d14f8a4f2eca7f965182d9fcf6e5ff) - GitHub
* **external**: Generate API docs from Rust code (#22437) [2b63353](https://github.com/answerbook/vector/commit/2b63353b68403b188c7126657336675fb24eb39e) - GitHub
* **external**: generate global option and common field from Rust macro (#22408) [c9076aa](https://github.com/answerbook/vector/commit/c9076aa240e46b7299f4caa9c0ca89de7704ae08) - GitHub
* **external**: improve debugging guide (#22735) [a2728eb](https://github.com/answerbook/vector/commit/a2728ebae5568f0999add804bcebbb45c845ee09) - GitHub
* **external**: improve proto codecs docs (#22280) [17d14d3](https://github.com/answerbook/vector/commit/17d14d3b150569a87f7fec9288c16601ce0064de) - GitHub
* **external**: introduce debugging guide (#22417) [a0b6cad](https://github.com/answerbook/vector/commit/a0b6cadbb77905589663a7b05c1a8b6239a9000b) - GitHub
* **external**: update guide to use new config instead of deprecated one (#22775) [4d8f03e](https://github.com/answerbook/vector/commit/4d8f03ed9b00bf276d88092395ec28cad1b0a5d4) - GitHub
* **external**: update vector tap help (#22490) [8dce2dd](https://github.com/answerbook/vector/commit/8dce2dd6a68fdcb839a222d5600100fb8536fdeb) - GitHub
* **gcp_chronicle sink**: Add default fallback logic if log_type template cannot be resolved fo… (#22323) [0d57e2a](https://github.com/answerbook/vector/commit/0d57e2aed0b300a8fbe9626283582578484c1620) - GitHub
* **gcp_chronicle sink**: add support for all Google SecOps regional endpoints (#22033) [56d6a7d](https://github.com/answerbook/vector/commit/56d6a7d89a7306fe682daf90f6c35fb2b3f4d072) - GitHub
* **http source**: unifying http query parameters (#22242) [9bb3712](https://github.com/answerbook/vector/commit/9bb3712cdf88c07cfeffed07d7640297464c8ed3) - GitHub
* **internal docs**: Fix dead link on commit sub-categories (#22520) [c3d0f08](https://github.com/answerbook/vector/commit/c3d0f080af57f7da950d335e0b16925decfcb28c) - GitHub
* **internal docs**: fix dead link on web playground README (#22681) [e1bfa9e](https://github.com/answerbook/vector/commit/e1bfa9e648feafcdeb90c574797cbeeb0925739d) - GitHub
* **internal**: Implement Display trait for Discriminant type (#22732) [5b490da](https://github.com/answerbook/vector/commit/5b490dabc6aac5de534862438a96a3b52354ce09) - GitHub
* **throttle transform**: Refactor throttle/rate limiter logic into reusable wrapper (#22719) [44562f6](https://github.com/answerbook/vector/commit/44562f6b3b8a1682009f0a34dc9fb61f3e668dbf) - GitHub
* **unit tests**: Allow objects and arrays in log_fields test input (#22406) [4c3f3ca](https://github.com/answerbook/vector/commit/4c3f3ca68f586dc8c62a3603ea77a0583ba6e9e0) - GitHub
* **vector source**: add `headers` option (#22695) [2a85007](https://github.com/answerbook/vector/commit/2a85007ce5c0ea05cdb408f4d6c898049c33f055) - GitHub
* **vrl**: add documentation for `to_syslog_facility_code` vrl function (#22241) [add77d0](https://github.com/answerbook/vector/commit/add77d0876436f2ed7f25ad55b54c0e58add48d1) - GitHub
* **vrl**: Add parse_cbor vrl function documentation (#22082) [970606e](https://github.com/answerbook/vector/commit/970606eb6f14c393b7d7e9cb9dd271a8a202d401) - GitHub
* **vrl**: Update documentation for ip_cidr_contains (#22463) [63cadc6](https://github.com/answerbook/vector/commit/63cadc68a606d0f0033a17b9965d133cd6c293a6) - GitHub
* **website**: add `alpha` definition (#22635) [9668f2d](https://github.com/answerbook/vector/commit/9668f2da58ba9b8030a5f70f141be82b834d0cd0) - GitHub
* **website**: fix incorrect example about the contains function (#22724) [e44cd91](https://github.com/answerbook/vector/commit/e44cd9106f84a9a9e87f2e82506113b970f40d0d) - GitHub
* **websocket_server sink**: add `how_it_works` section for `websocket_server` (#22482) [30f7a12](https://github.com/answerbook/vector/commit/30f7a12c736f93a74990355de0708d56cb81e895) - GitHub

# [10.0.0](https://github.com/answerbook/vector/compare/v9.0.1...v10.0.0) (2025-08-06)


### Bug Fixes

* **ci**: macOS runner for Intel (#22134) [d78f968](https://github.com/answerbook/vector/commit/d78f968e6f5046dfd3eff0ff2b5285c5bcab27d6) - GitHub
* **ci**: multiple workflows need 'contents: write' permissions (#21940) [aa48fea](https://github.com/answerbook/vector/commit/aa48feaed2d8a2f1f705e181852b4bec4cb0ad95) - GitHub
* **clickhouse sink**: make `skip_unknown_fields` optional (#22020) [f8f33b5](https://github.com/answerbook/vector/commit/f8f33b5afe87ea10d3395d5636594a9078e15cf8) - GitHub
* **config**: Correct `filter` transform generation via `vector generate` to use a comparison (#22079) [d15dc01](https://github.com/answerbook/vector/commit/d15dc0153fcdd256fa6b1231aaa0b2f10ff6b171) - GitHub
* **config**: correctly propagate http config provider Result to caller (#21982) [d38961a](https://github.com/answerbook/vector/commit/d38961a6f785a2245625a50fc32aecef866b77c9) - GitHub
* **dev**: update publicsuffix to use newer `idna` (#21996) [6dbe5da](https://github.com/answerbook/vector/commit/6dbe5dac1d537a5484fb5f5ab228d41ba5b9f0c6) - GitHub
* **file source**: use uncompressed content for fingerprinting files (lines and ignored_header_bytes) (#22050) [68ee4f2](https://github.com/answerbook/vector/commit/68ee4f27d09084a4f9f28d167c4610a5e83067bd) - GitHub
* **gcp_pubsub source**: Remove Tonic default 4MB decode size limit (#22091) [3b90e26](https://github.com/answerbook/vector/commit/3b90e2695c6f878f78ef7d1699711d8bbca6ae40) - GitHub
* **internal_metrics source**: Emit `build_info` gauge on an interval (#21991) [9784a98](https://github.com/answerbook/vector/commit/9784a985ceb7ea35ca5021170fac6c6874a13edd) - GitHub
* **kafka sink**: retry messages that result in kafka policy violations (#22041) [1275f1a](https://github.com/answerbook/vector/commit/1275f1ad67ea02cb0ba4ca476695268611d1f185) - GitHub
* **kubernetes_logs source**: Set user-agent for k8s apiserver requests. (#21905) [434e742](https://github.com/answerbook/vector/commit/434e742df2dbf9bb6a3e8ffdf2dc781a34096965) - GitHub
* **opentelemetry sink**: input() should delegate to internal config input() (#22126) [f59fd9c](https://github.com/answerbook/vector/commit/f59fd9c2b129fc1732146ac7f5cf515843ea8665) - GitHub
* **reduce transform**: enable quoting for invalid fields (#21989) [46521dc](https://github.com/answerbook/vector/commit/46521dccaf47a57803dba55b87c60087c1d364b3) - GitHub
* **sample transform**: use configured sample_rate_key value (#21971) [13a5508](https://github.com/answerbook/vector/commit/13a5508ed1d9bb74ba96e86ab71a00c62e9f53d4) - GitHub


### Chores

* **ci**: Bump bufbuild/buf-setup-action from 1.47.2 to 1.48.0 (#22078) [922937f](https://github.com/answerbook/vector/commit/922937fd89740e259f7bf02322d19538b5536d83) - GitHub
* **ci**: Bump bufbuild/buf-setup-action from 1.48.0 to 1.49.0 (#22163) [a02d296](https://github.com/answerbook/vector/commit/a02d29623f8d78a23426706c1eb9c9d5505ab904) - GitHub
* **ci**: Bump cargo-deny timeout (#22058) [656136a](https://github.com/answerbook/vector/commit/656136a922500cfbd367e800adf33708ce484126) - GitHub
* **ci**: Bump docker/build-push-action from 6.10.0 to 6.11.0 (#22165) [801a229](https://github.com/answerbook/vector/commit/801a229642a628e1d26c8830fd7a871c4666b470) - GitHub
* **ci**: Bump docker/setup-buildx-action from 3.7.1 to 3.8.0 (#22039) [a0dfa2b](https://github.com/answerbook/vector/commit/a0dfa2bc40be16e0b80bcf2c76d9b6fb66c19380) - GitHub
* **ci**: Bump docker/setup-qemu-action from 3.2.0 to 3.3.0 (#22164) [deb5846](https://github.com/answerbook/vector/commit/deb5846c860f6d4e33a0547a5296e07113e51e6f) - GitHub
* **ci**: Bump timeout for cli tests (#22056) [485c38b](https://github.com/answerbook/vector/commit/485c38b0ca77a87b214857d6c5ec6d256efacfe2) - GitHub
* **ci**: Bump xt0rted/pull-request-comment-branch from 2 to 3 (#21843) [e91fec6](https://github.com/answerbook/vector/commit/e91fec648a4e3f034cd12576185320f3269405a2) - GitHub
* **ci**: change some  dependabot schedules to weekly (#21930) [d4a278e](https://github.com/answerbook/vector/commit/d4a278e5aa624615efc076afe5b246953f3c0a8d) - GitHub
* **ci**: dependabot allow all dep types (#21958) [53e4c66](https://github.com/answerbook/vector/commit/53e4c666d1780e80ea66e12ef182e46834a22220) - GitHub
* **ci**: Fix baseline SHA default for new weekly schedule (#21980) [d4854de](https://github.com/answerbook/vector/commit/d4854ded038f2852c2676c89bf89bf075dd7f914) - GitHub
* **ci**: Fix integration test file syntax (#22025) [69bfb12](https://github.com/answerbook/vector/commit/69bfb1242033a30403ed1ac2541a9e4c7bce2de8) - GitHub
* **ci**: Fix SMP job timeouts (#22043) [d4fc91f](https://github.com/answerbook/vector/commit/d4fc91f8482bc0ef4e16fef021e7dac9eca7bb81) - GitHub
* **ci**: Pin ubuntu versions in GHA (#22044) [475e93f](https://github.com/answerbook/vector/commit/475e93f182cc51e06ca74f8545a245203bcec1d0) - GitHub
* **ci**: Revert "dependabot allow all dep types" (#22160) [a976987](https://github.com/answerbook/vector/commit/a976987b8cd7a5ad2a92cbd5d3f98c4572266180) - GitHub
* **ci**: run nightly workflow on weekday commits (only) (#21987) [7013ded](https://github.com/answerbook/vector/commit/7013ded278e5436ee371122060310c9a3dfdf457) - GitHub
* **ci**: run regression suite weekly (#21979) [9d498fc](https://github.com/answerbook/vector/commit/9d498fc6a62bc01378c3f67ed38e81d6e6d22d9c) - GitHub
* **ci**: Skip humio integration tests in CI (#22016) [0b801eb](https://github.com/answerbook/vector/commit/0b801ebad6a4cd7c0ae23ba6e26ecfba73d48ed4) - GitHub
* **ci**: SMP Upgrade (#22010) [81c2155](https://github.com/answerbook/vector/commit/81c215527d39837808a324075d6290afb3a5a4b2) - GitHub
* **ci**: Update lading to 0.25.3, lower resource allocations in experiments (#22147) [45cd651](https://github.com/answerbook/vector/commit/45cd651cc90e629d0835e0f8e8262213c60bb29b) - GitHub
* **ci**: Use newest SMP version (#22004) [2f53b1c](https://github.com/answerbook/vector/commit/2f53b1cb32df2d914b5029ce4dd5c7a7455d03a8) - GitHub
* **deps**: Bump bytes from 1.8.0 to 1.9.0 (#21912) [daa9f24](https://github.com/answerbook/vector/commit/daa9f24cfec8617e04603b2701782d6705b865c2) - GitHub
* **deps**: Bump colored from 2.1.0 to 3.0.0 (#22170) [949b541](https://github.com/answerbook/vector/commit/949b5413f2f276b8224d39335a51e2ef972e9a6c) - GitHub
* **deps**: Bump hashbrown to 0.15.2 (#21962) [f929a9a](https://github.com/answerbook/vector/commit/f929a9ab1cd229a8df342a6b9230c5cbee6e588d) - GitHub
* **deps**: Bump indexmap from 2.6.0 to 2.7.0 (#21934) [4f14967](https://github.com/answerbook/vector/commit/4f14967d156ccbbe6f042f5c264389a33d3fd865) - GitHub
* **deps**: Bump itertools from 0.13.0 to 0.14.0 (#22176) [eba81f4](https://github.com/answerbook/vector/commit/eba81f4d35f63ec4ccbfc4136711ad5265370e37) - GitHub
* **deps**: Bump nanoid from 3.3.6 to 3.3.8 in /website (#22001) [9a71bc3](https://github.com/answerbook/vector/commit/9a71bc39cb7ddb6904743e90645f8491539ce1f6) - GitHub
* **deps**: Bump os_info from 3.8.2 to 3.9.0 (#21935) [0309517](https://github.com/answerbook/vector/commit/03095171a60a25755d8b1efc1886940666ce6b7f) - GitHub
* **deps**: Bump patched tokio-util to 0.7.13 (#21966) [f4cda44](https://github.com/answerbook/vector/commit/f4cda444cb363a19e017383d91c4f0ddc7d7050f) - GitHub
* **deps**: Bump rdkafka from 0.35.0 to 0.37.0 (#21929) [3a89c8e](https://github.com/answerbook/vector/commit/3a89c8ed54269cbeb2a5ddc3dcc75e920721171b) - GitHub
* **deps**: Bump rstest from 0.23.0 to 0.24.0 (#22180) [3077efc](https://github.com/answerbook/vector/commit/3077efc5e2c1128f3527045aad64768ff05f3b25) - GitHub
* **deps**: Bump rustls-pemfile from 1.0.3 to 1.0.4 (#21886) [2d785c3](https://github.com/answerbook/vector/commit/2d785c374b3bde2d5cb2e1366662098dda985f2d) - GitHub
* **deps**: Bump serde_with from 3.11.0 to 3.12.0 (#22179) [cc8d4e4](https://github.com/answerbook/vector/commit/cc8d4e48481f7c7793fea1458dfaa8086006a0be) - GitHub
* **deps**: Bump tempfile from 3.14.0 to 3.15.0 (#22175) [6a50999](https://github.com/answerbook/vector/commit/6a50999a8a4f7583ffeb16a16e4a3742f59141ab) - GitHub
* **deps**: Bump the patches group across 1 directory with 7 updates (#21927) [77bbbb4](https://github.com/answerbook/vector/commit/77bbbb46ef814e5112f036f1d7c6cadbd84e9798) - GitHub
* **deps**: Bump the patches group with 4 updates (#21944) [1ae5a5c](https://github.com/answerbook/vector/commit/1ae5a5cf961df318ee50239e97aaa4d1cc7546db) - GitHub
* **deps**: Bump tokio from 1.42.0 to 1.43.0 (#22178) [3e213db](https://github.com/answerbook/vector/commit/3e213db56beac5f84fe3c92f8cb169026cb10647) - GitHub
* **deps**: Bump twox-hash from 2.0.1 to 2.1.0 (#22182) [269e862](https://github.com/answerbook/vector/commit/269e8627f9823fa3657bc74bcdf2b1882f7ea718) - GitHub
* **deps**: bump VRL (#22135) [0af3e44](https://github.com/answerbook/vector/commit/0af3e44511d238d95e25b2ec14b6396f12b2c64a) - GitHub
* **deps**: Bump vrl from `a958c5d` to `c8af70c` (#21936) [4de5a77](https://github.com/answerbook/vector/commit/4de5a773f0a2c82318352876b597b18190549332) - GitHub
* **deps**: bump vrl@2.1.0 [skip lint] [2eb8c18](https://github.com/answerbook/vector/commit/2eb8c185ae73a42d99f1d148ae5fd3da7864cf86) - Mike Del Tito [LOG-22137](https://logdna.atlassian.net/browse/LOG-22137)
* **deps**: Ignore RUSTSEC-2024-0421 temporarily (#22000) [ae05a47](https://github.com/answerbook/vector/commit/ae05a475beb91a3bcb3efc0406a531e4b738ccce) - GitHub
* **deps**: Regenerate Cargo.lock (#22048) [d44c5d6](https://github.com/answerbook/vector/commit/d44c5d60655d8df7e70f0b68b8a12381c3fb25f7) - GitHub
* **deps**: remove some unused deps (#22021) [08bb46f](https://github.com/answerbook/vector/commit/08bb46fb3a3c7c4b9e8b73be7e4e0bd445213b6d) - GitHub
* **deps**: Update Rust toolchain to 1.83.0 (#22068) [ca084cc](https://github.com/answerbook/vector/commit/ca084cc1473c08c5a91ab79fe6c6c4c6a3f4fab8) - GitHub
* **deps**: Update to Rust 1.82.0 (#22030) [7e93489](https://github.com/answerbook/vector/commit/7e93489fdb784c69074d4db17fd379554c62d77a) - GitHub
* **dev**: add cargo commands to PR template (#22159) [3e3614e](https://github.com/answerbook/vector/commit/3e3614ee14af2613222426ec0c1b5c36d7ee360b) - GitHub
* **dev**: Bump regression replicas to 100 (#21986) [a14aac7](https://github.com/answerbook/vector/commit/a14aac7f8029b376baa286a1e2eac5fa295a00f0) - GitHub
* **dev**: mention job manual trigger (#21954) [b400258](https://github.com/answerbook/vector/commit/b400258c5a82f7428abd7c31fc421b9a1c4c5f70) - GitHub
* **dev**: Regenerate Cargo.lock to fix bad conflict resolution (#21957) [d5e9cbb](https://github.com/answerbook/vector/commit/d5e9cbbf7efeeafd79cdde1f97c0aa80f04b2de6) - GitHub
* **dev**: replace the aqua local registry with the standard registry (#21959) [f9b7468](https://github.com/answerbook/vector/commit/f9b7468782de38f1a24dcf49d4b28d9af794ba56) - GitHub
* **dev**: Switch to new humio image (#22015) [f73fb10](https://github.com/answerbook/vector/commit/f73fb10277b14d3e16884720a96d20c2bbd0550a) - GitHub
* **dev**: tweaks to the minor release guide (#21952) [4783ee2](https://github.com/answerbook/vector/commit/4783ee269d2704fdcf8a6d7485682674c7913cd6) - GitHub
* **external docs**: render array of object type in component docs (#22138) [99af5be](https://github.com/answerbook/vector/commit/99af5be92ff440d7bcd13993c6c320c724c82055) - GitHub
* **greptimedb_metrics sink**: fix greptimedb examples (#21984) [70837f3](https://github.com/answerbook/vector/commit/70837f3b1f45c82f951e71ebf3480152ac569690) - GitHub
* **releasing**: build manifests for vector 0.43.1 chart 0.38.1 (#22019) [fa392e1](https://github.com/answerbook/vector/commit/fa392e1fb4e6219601269e4a6c8c083b47f3d9a7) - GitHub
* **releasing**: bump vector version to 0.44.0 (#21955) [32df3cd](https://github.com/answerbook/vector/commit/32df3cdcb4b8ced2b786525feb00372701b1c698) - GitHub
* **releasing**: cargo vdev build manifests (#21956) [17b7f1a](https://github.com/answerbook/vector/commit/17b7f1af5703c590f12cfced48ab01829f7d6a30) - GitHub
* **releasing**: cherry-pick v0.43.1 patch commits (#22011) [b6a59c7](https://github.com/answerbook/vector/commit/b6a59c72692da81c83195217be1b97f5e1e58009) - GitHub
* **releasing**: Prepare v0.43.0 (#21906) [023f5fe](https://github.com/answerbook/vector/commit/023f5fef2775dc676122159d1733ec1f88849c4f) - Pavlos Rontidis
* **releasing**: Prepare v0.44.0 (#22192) [3cdc7c3](https://github.com/answerbook/vector/commit/3cdc7c3d722fa50273beaa4bd02b6810f86ca3fa) - Pavlos Rontidis
* **soak tests**: Increases inner GH action timeout to match job-level timeout (#22038) [d8dcf6c](https://github.com/answerbook/vector/commit/d8dcf6c1ade08cec43a7d184a40db1561e28dad8) - GitHub
* **socket sink**: Revert addition of unix datagram mode (#22113) [2ed4cd9](https://github.com/answerbook/vector/commit/2ed4cd971d14c17c392143d44ac07488e116f7ed) - GitHub
* **tests**: Update year for parse_klog test (#22109) [f6295e7](https://github.com/answerbook/vector/commit/f6295e758b95ba26fed7cfb43e2731066a3c2d63) - GitHub
* **vrl**: Fix example for linux auth log (#22110) [5cad353](https://github.com/answerbook/vector/commit/5cad353cca492db26d3b6eecf8a61a052fac6f99) - GitHub
* **vrl**: re-enable `parse_dnstap` without VRL playground support (#22124) [08303a1](https://github.com/answerbook/vector/commit/08303a156cc08d05cc0b31ac45426940818bee63) - GitHub
* **vrl**: Revert add `parse_dnstap` function (#22114) [f3549db](https://github.com/answerbook/vector/commit/f3549dbc00d285e06ee109233508a7fc3e02d099) - GitHub
* **website**: bump hugo to latest version (#22018) [18de1ea](https://github.com/answerbook/vector/commit/18de1ea8a10bbe472bafca17c775b0fb8eaa0ed6) - GitHub
* **website**: remove obsolete mentions to netlify (#22162) [bd976f1](https://github.com/answerbook/vector/commit/bd976f1d1d3a8f7e1bfe6eb6db9019b768457e76) - GitHub
* **website**: Render chores for release changelog (#21990) [e8a836f](https://github.com/answerbook/vector/commit/e8a836f412cd41007afa176537784afdcd6d0cd3) - GitHub


### Features

* **aws_s3 sink**: add option to use virtual addressing (#21999) [029a2ff](https://github.com/answerbook/vector/commit/029a2ffc33c66fe1d8b755ad309b695317b1f542) - GitHub
* **ci**: introduce OSSF scorecard (#21942) [129245a](https://github.com/answerbook/vector/commit/129245a38a95af8f5ba073e0d1729ff4534cd15b) - GitHub
* **ci**: publish ARM macOS builds (#22140) [0720345](https://github.com/answerbook/vector/commit/0720345ef61398819174290fd6c4de6d0e1e9446) - GitHub
* **file sink**: supports input based on encoding type (#21726) [dd8ed5d](https://github.com/answerbook/vector/commit/dd8ed5dfa5e716c0ce8bff0b3f25398b5f5f09d0) - GitHub
* **host_metrics source**: Add additional cgroup memory metrics (#22153) [f0fec05](https://github.com/answerbook/vector/commit/f0fec05fa572c6d40b7a93d636414e103d35b659) - GitHub
* **log_to_metric transform**: support tags expansion similar to `labels expansion` for loki sink (#21939) [ff8dfb7](https://github.com/answerbook/vector/commit/ff8dfb7fc76a799caac703e426d1e5c24da581fa) - GitHub
* **vrl**: add `parse_dnstap` function (#21985) [792aeea](https://github.com/answerbook/vector/commit/792aeeae5c216288bc11b78185ecfb7184ac3ece) - GitHub


### Miscellaneous

* Merge pull request #694 from answerbook/feature/LOG-22137 [db617b9](https://github.com/answerbook/vector/commit/db617b97467b0488a0298a9acb0c6e5cea5936db) - GitHub [LOG-22137](https://logdna.atlassian.net/browse/LOG-22137)
* Merge tag 'v0.44.0' into feature/LOG-22137 [skip lint] [24b4021](https://github.com/answerbook/vector/commit/24b4021241cada5cf38b4748f5be1fa11a3f503a) - Mike Del Tito [LOG-22137](https://logdna.atlassian.net/browse/LOG-22137) [LOG-22137](https://logdna.atlassian.net/browse/LOG-22137)
* **aws_s3 sink**: add glacier instant retrieval storage class (#22123) [343ab7c](https://github.com/answerbook/vector/commit/343ab7c0d57af5448712a8dd1adcab3e91bdc08b) - GitHub
* **aws_s3 source**: Logs processed S3 objects (#22083) [1ef01ae](https://github.com/answerbook/vector/commit/1ef01aeeef592c21d32ba4d663e199f0608f615b) - GitHub
* **elasticsearch sink**: Add option to specify a default index if template cannot be resolved for Elasticsearch destination index (#21953) [6de31c3](https://github.com/answerbook/vector/commit/6de31c3d70f7f6eb7c46f68eac34575b3132e304) - GitHub
* **exclusive_route transform, route transform**: fix links in route/exclusive route (#21964) [8bcc00f](https://github.com/answerbook/vector/commit/8bcc00f49de193d69d3291be50a189fed9356b37) - GitHub
* **external**: add known issue for v0.43.1 (#22139) [c593d45](https://github.com/answerbook/vector/commit/c593d4550a50c756a9ff5518a185cc8f83dc36fc) - GitHub
* **external**: add notice for 'to_float' (#21973) [87c04eb](https://github.com/answerbook/vector/commit/87c04ebc72fad70f3326f74632d283592d8920a1) - GitHub
* **external**: add parse_klog notice (#22111) [2594837](https://github.com/answerbook/vector/commit/25948370afa3ceae74404391c30d695a4fb17dd2) - GitHub
* **external**: fix fallibility badge (#21977) [d3f160b](https://github.com/answerbook/vector/commit/d3f160bccc588cc72f3b8d398fce15fce3894f67) - GitHub
* **external**: fix network_* metric type (#22118) [35845a1](https://github.com/answerbook/vector/commit/35845a19df01a33c62f7443125d436ab6404cfa2) - GitHub
* **external**: remove obsolete note (#22012) [2815ec0](https://github.com/answerbook/vector/commit/2815ec08c3ecac38f768be7274ddb560c4423722) - GitHub
* **nats sink**: can now parse multiple nats urls (#21823) [f8af40e](https://github.com/answerbook/vector/commit/f8af40e05ac49b6978c518e6f226a96d2f69ee73) - GitHub
* **socket sink**: support unix datagram mode (#21762) [7c6d0c9](https://github.com/answerbook/vector/commit/7c6d0c942831441c4aa84ecedfb19c627d3f426d) - GitHub
* **socket sink**: support unix datagram mode (#22120) [8668cde](https://github.com/answerbook/vector/commit/8668cdeaf696ea63af2262c4307bc85cf536683d) - GitHub
* **vrl**: add crc vrl function docs (#21924) [a632a93](https://github.com/answerbook/vector/commit/a632a93b0e4384754772793e6f412d906ec65a7d) - GitHub
* **vrl**: add docs for new `parse_bytes` function (#22089) [92a1034](https://github.com/answerbook/vector/commit/92a1034a13cdb094d29d8dcbd886a6e9ed18dd73) - GitHub
* **vrl**: add docs for new `timezone` option in parse_timestamp function (#22121) [5de96d4](https://github.com/answerbook/vector/commit/5de96d4b7f85a883eedbff8a889a3f41b012abc2) - GitHub
* **vrl**: Add documentation for new `object_from_array` function (#21969) [890a60a](https://github.com/answerbook/vector/commit/890a60ade8b73bb7bc26c10ad0a6dad7707d7ead) - GitHub
* **vrl**: Add documentation for new `zip` function (#21941) [a8371dd](https://github.com/answerbook/vector/commit/a8371dd06b35f61a8afeb8b745287c2dfeef4f1a) - GitHub
* **vrl**: add example syntax for valid expressions. (#21963) [75f35e2](https://github.com/answerbook/vector/commit/75f35e2379e44614c811ee7ff5e6c0ab99ad2b89) - GitHub
* **vrl**: add more `parse-duration` function doc (#22088) [4605e5b](https://github.com/answerbook/vector/commit/4605e5bb54d6d2fe47163c09f771670f96c68b3f) - GitHub
* **vrl**: decode_charset.cue, encode_charset.cue documentations (#21981) [8d94da8](https://github.com/answerbook/vector/commit/8d94da81f8461754d04ef4c4b78b7a0daf9162a1) - GitHub
* **vrl**: update documentation for `parse_nginx_log` with the `main` log format (#22119) [f8fde0f](https://github.com/answerbook/vector/commit/f8fde0f3fef4f067280153c0d525f904166a006f) - GitHub
...
* **ci**: add missing dep (#21900) [4251fe0](https://github.com/answerbook/vector/commit/4251fe0fb842f72c5460910ec605b8aac54a0231) - GitHub
* **ci**: add more perms for website preview workflows (#21849) [6253e06](https://github.com/answerbook/vector/commit/6253e0638f4083b12adb8214ccb559c2f7e15e37) - GitHub
* **ci**: deb-verify cannot use actions/checkout@v4 (#21658) [f2f38bc](https://github.com/answerbook/vector/commit/f2f38bc09554946a895134feb85fea5636c8a87b) - GitHub
* **ci**: drop ubuntu 23.04, use 24.04(LTS) (#21897) [69736cd](https://github.com/answerbook/vector/commit/69736cdc054e6ac09e0227107669e5c659e93d0f) - GitHub
* **ci**: fix publish workflow permissions (#21773) [ca05055](https://github.com/answerbook/vector/commit/ca05055a6a55abf1a201b51d9418e7262e6005ec) - GitHub
* **ci**: Revert to actions/[upload,download]-artifact@v3 (#21668) [9a0fe47](https://github.com/answerbook/vector/commit/9a0fe478f92537626a1e5d5f588bccd3d15b79d7) - GitHub
* **ci**: typo in permissions (#21856) [f5bbdb9](https://github.com/answerbook/vector/commit/f5bbdb9e1e1a9072e930426729464cd6d51e84ff) - GitHub
* **codecs**: Fix gelf deserialization of subsecond timestamps (#21613) [b05331e](https://github.com/answerbook/vector/commit/b05331e06eab11538fec8eb1c283a05e1b50a67b) - GitHub
* **config**: Enable support for YAML merge in configuration (#21731) [cb386ca](https://github.com/answerbook/vector/commit/cb386ca369873dca803d1b6327669643bed79050) - GitHub
* **datadog**: ensure metrics version in host is valid [skip lint] [ec41597](https://github.com/answerbook/vector/commit/ec415971afc3799a7ba8445d54599129642f75cf) - Mike Del Tito [LOG-22128](https://logdna.atlassian.net/browse/LOG-22128)
* **external docs**: add CI flag and use cue.sh (#21634) [42e2bb6](https://github.com/answerbook/vector/commit/42e2bb6e446fead5ffdb9a4c12c7f027528536b6) - GitHub
* **gh_action**: Prevent workflow from triggering unless previous workflow succeeds (#21579) [4a44e41](https://github.com/answerbook/vector/commit/4a44e41ac1929408a4142c63b6f10e17812be50e) - GitHub
* **honeycomb sink**: The batch body should be encoded as array (#21878) [a7204fa](https://github.com/answerbook/vector/commit/a7204fa549bf2501cface048f0abbbc8e5b2cb1c) - GitHub
* **http sink**: revert 21583 (#21885) [e0d3fb3](https://github.com/answerbook/vector/commit/e0d3fb30ec5dc2a4e10db20df5d2110a725712a5) - GitHub
* **sample transform**: component feature check fix (#21677) [710f224](https://github.com/answerbook/vector/commit/710f2245f9098d09afbdf7d2f8f2102938f66821) - GitHub
* **sinks/gcp/pubsub.rs**: remove pubsub log only restriction (#21557) [86fb074](https://github.com/answerbook/vector/commit/86fb0740f124b88eb08dd87d5f9383ed89916ad0) - GitHub
* **sources**: fix unexpected timestamp field (#21558) [a2b152d](https://github.com/answerbook/vector/commit/a2b152df8a27b74521df2bc437e64fcbf7978307) - GitHub
* **tests**: fixed numerous API tests issues  (#21650) [83a71cd](https://github.com/answerbook/vector/commit/83a71cdaebebe397ec3bf942f921b6747eebc12f) - GitHub
* **tests**: make the `TELEMETRY` singleton thread local for tests (#21697) [fb53a2d](https://github.com/answerbook/vector/commit/fb53a2d2d1b5d8771011fe36f1027a99800e8882) - GitHub
* **transforms**: Fix matching boolean values for Datadog search s… (#21624) [4c3aa35](https://github.com/answerbook/vector/commit/4c3aa3537724f746d1d712c6bff75efd0d8fe0a9) - GitHub
* **vrl**: mark set_semantic_meaning impure (#21896) [064406d](https://github.com/answerbook/vector/commit/064406dd0cac0f9efa866e1c3536da3e93d7b692) - GitHub


### Chores

* **administration**: add SMP as code owners for the "regression/" dir tree (#21597) [f8897c8](https://github.com/answerbook/vector/commit/f8897c8f6c6d433a93bbd2123316ea3832aef0c3) - GitHub
* **administration**: improve GitHub PR template (#21651) [a59f59c](https://github.com/answerbook/vector/commit/a59f59cdda2852d38758460b52af88e3c8cf7368) - GitHub
* **administration**: tweak PR template (#21660) [3b35d1a](https://github.com/answerbook/vector/commit/3b35d1ac9f269f4f0ce96a8d227d7214d140c1b6) - GitHub
* **ci**: add issues write perms to build_preview_sites.yml (#21845) [fb9b42d](https://github.com/answerbook/vector/commit/fb9b42d34af91d7d56a292c135993556e2a5b088) - GitHub
* **ci**: Add SMP as CODEOWNERS for .github/workflows/regression.yml (#21529) [dfaabf7](https://github.com/answerbook/vector/commit/dfaabf707b4861764ba9329dd50895d8c1f2b926) - GitHub
* **ci**: add source changed gate in test.yml (#21539) [ad3de7e](https://github.com/answerbook/vector/commit/ad3de7eebb17533a41e96b893e13a6c838b9dd67) - GitHub
* **ci**: Add statuses write permission to workflows (#21788) [9fa3516](https://github.com/answerbook/vector/commit/9fa3516eb21b5404d447bd434e2bfed6fa1b555f) - GitHub
* **ci**: additional scopes (#21621) [4bb1f99](https://github.com/answerbook/vector/commit/4bb1f99cd72a7fae84a14735eaa5fb97ba38dae5) - GitHub
* **ci**: Bump bufbuild/buf-setup-action from 1.45.0 to 1.46.0 (#21661) [c55741b](https://github.com/answerbook/vector/commit/c55741b8e64431ced32277f4196f158e643012fb) - GitHub
* **ci**: Bump bufbuild/buf-setup-action from 1.46.0 to 1.47.2 (#21797) [dadf5e4](https://github.com/answerbook/vector/commit/dadf5e4d0b4a60c43333386233a761966bcaa9be) - GitHub
* **ci**: Bump check-spelling/check-spelling from 0.0.21 to 0.0.24 (#21678) [02a756e](https://github.com/answerbook/vector/commit/02a756efc012b065b316fbd6ab30e1a6b5a71b91) - GitHub
* **ci**: Bump docker/build-push-action from 6.9.0 to 6.10.0 (#21894) [3e99504](https://github.com/answerbook/vector/commit/3e995042dcaeec60dbddfe16acbc63062162e5d9) - GitHub
* **ci**: Bump docker/metadata-action from 5.5.1 to 5.6.1 (#21842) [fdecc6f](https://github.com/answerbook/vector/commit/fdecc6f969069b052004435e8b073223d9ef81a6) - GitHub
* **ci**: Bump the artifact group with 2 updates (#20055) [f722135](https://github.com/answerbook/vector/commit/f72213580b48358add79f37a9b5f2b3ef5b511c9) - GitHub
* **ci**: Clear space at the start of the k8s e2e workflow (#21723) [ac19c7c](https://github.com/answerbook/vector/commit/ac19c7cc05d85aeb615bd10f2a58b080b013b250) - GitHub
* **ci**: delete unused output in the regression workflow (#21527) [ac0e4ca](https://github.com/answerbook/vector/commit/ac0e4cacfb64fd45c72c2bdfd918cfc3da2a8b12) - GitHub
* **ci**: delete unusued deps from ubuntu bootstrap (#21841) [6cf6df5](https://github.com/answerbook/vector/commit/6cf6df5af282514cd48b534e027faf2c5c69b0fe) - GitHub
* **ci**: fix ignore filter (#21580) [25fe9b8](https://github.com/answerbook/vector/commit/25fe9b897b4076cd1df3adc630518cd8903328f6) - GitHub
* **ci**: Fix scraping of target metrics by lading (#21530) [21d9e50](https://github.com/answerbook/vector/commit/21d9e50f82bac249247743906ca9bb7fbfead90d) - GitHub
* **ci**: Group together patch updates with dependabot (#21595) [776f4c6](https://github.com/answerbook/vector/commit/776f4c62907c5cbe49244b250592d2c732604e09) - GitHub
* **ci**: Ignore RUSTSEC-2024-0336 (#21758) [f4eddbc](https://github.com/answerbook/vector/commit/f4eddbcdca671f6843ecafb4ec05e48bd899c51d) - GitHub
* **ci**: Limit spellchecker to user-facing content (#21680) [431baac](https://github.com/answerbook/vector/commit/431baac2ec3ccf472e86e79be2a3ed82f3d6ce4a) - GitHub
* **ci**: print line numbers with trailing spaces (#21568) [efc9db9](https://github.com/answerbook/vector/commit/efc9db951f144d56f2f6b0182f5659661d79a082) - GitHub
* **ci**: publish to docker retry (#21825) [e90df6b](https://github.com/answerbook/vector/commit/e90df6b75ef9d27a0c7341da18fadba1787db1c7) - GitHub
* **ci**: regression detection v2 followups (#21594) [4617145](https://github.com/answerbook/vector/commit/461714564471189788e77eb9ebb63acd3a9fdb0a) - GitHub
* **ci**: remove 'unset HOMEBREW_NO_INSTALL_FROM_API' line (#21787) [b32ea2f](https://github.com/answerbook/vector/commit/b32ea2f820833874623f4163d13aced7195da97c) - GitHub
* **ci**: Remove environment stage name (#21681) [b5de16c](https://github.com/answerbook/vector/commit/b5de16c0c12d1c2270f54dd2d6aeef1ef3bdd25b) - GitHub
* **ci**: remove ubuntu 16 from publishing targets (#21639) [1fe4152](https://github.com/answerbook/vector/commit/1fe415263b5fc779a331730c7ca3684f47bb129a) - GitHub
* **ci**: Remove vestigial commit status steps from regression workflow (#21784) [cac47ff](https://github.com/answerbook/vector/commit/cac47ff4b15b16b7ed5baa92fe3f70861478ae0c) - GitHub
* **ci**: replace regression workflow (#21600) [31732b0](https://github.com/answerbook/vector/commit/31732b0ff1331fa112cb3530547b76a5645dfd15) - GitHub
* **ci**: revert recent changes to the regression workflow (#21541) [93f71f1](https://github.com/answerbook/vector/commit/93f71f1b52e7d54cee0aa1a586571f601119695d) - GitHub
* **ci**: rework Semantic check workflow (#14723) [5d8736f](https://github.com/answerbook/vector/commit/5d8736f1a3ec40165f027138bd8913eb94df59cf) - GitHub
* **ci**: Run regression tests if workflow changed (#21521) [1309eb9](https://github.com/answerbook/vector/commit/1309eb925dd4735bc61a8cbe20e85f69a8dbe5b7) - GitHub
* **ci**: set regression workflow timeouts to 70 mins (#21582) [21ae5d0](https://github.com/answerbook/vector/commit/21ae5d007d693e74e539cc584fdc41cd72c83437) - GitHub
* **ci**: skip regression checks for PRs with the `ci-condition: skip-regression` label (#21507) [55fd455](https://github.com/answerbook/vector/commit/55fd45540ebafd869853a7a29d984efd40fc4e88) - GitHub
* **ci**: update actions/checkout to v4 (#21571) [75c5a4d](https://github.com/answerbook/vector/commit/75c5a4d5f0b7004091ee4dd1b1595d9daf64b572) - GitHub
* **ci**: update all remaining GitHub actions v3 packages to v4 (#21722) [a17312e](https://github.com/answerbook/vector/commit/a17312e0c4acd3cea09847a4d5e2a1b75cde3a02) - GitHub
* **ci**: Update check-spelling to 0.0.22 (#21733) [0527544](https://github.com/answerbook/vector/commit/0527544711c68f673b46cad3168332b8bec2684d) - GitHub
* **ci**: Upgrade check-spelling to 0.0.24 (#21737) [a89b6b2](https://github.com/answerbook/vector/commit/a89b6b2cf763fa7520887b00b299a020b3fd75ef) - GitHub
* **ci**: Use free OSS 4 vCPU runners (#19683) [c7441ec](https://github.com/answerbook/vector/commit/c7441ec082948e633e1a898e319d26ef19d74424) - GitHub
* **CODEOWNERS**: remove OP team (#21551) [e12247e](https://github.com/answerbook/vector/commit/e12247e3b4cf19b0a9d11e362d351372f262bcbb) - GitHub
* **config**: Default `expire_internal_metrics` to 300s (#20710) [ab679fb](https://github.com/answerbook/vector/commit/ab679fbfe137da7544873662637ec0404b60d0dd) - GitHub
* **config**: log component graph when there's an error  (#21669) [e2b83f2](https://github.com/answerbook/vector/commit/e2b83f21949d8744a67d3e4ec39c0e1389169672) - GitHub
* **core**: Wrap event metadata in `Arc` for performance (#21188) [86c313f](https://github.com/answerbook/vector/commit/86c313f7fecff3c7300296f70f7667398e145eed) - GitHub
* **deps**: Bump `metrics` to 0.24.0 (#21550) [dc441a2](https://github.com/answerbook/vector/commit/dc441a28bb8dda527e79bbc3e8145bcb5ee0cadf) - GitHub
* **deps**: Bump async-compression from 0.4.14 to 0.4.15 (#21502) [c22f6bd](https://github.com/answerbook/vector/commit/c22f6bddefeef4933dd1cec0d8ca46900e02ba86) - GitHub
* **deps**: Bump async-compression from 0.4.15 to 0.4.16 (#21533) [400a17c](https://github.com/answerbook/vector/commit/400a17c8aa3245512ae79c1c594034f46b4eb976) - GitHub
* **deps**: Bump bstr from 1.10.0 to 1.11.0 (#21807) [7355e9a](https://github.com/answerbook/vector/commit/7355e9ad086577913c3c92f792f5f15586fa6b1e) - GitHub
* **deps**: Bump bytes from 1.7.2 to 1.8.0 (#21576) [2c24f7e](https://github.com/answerbook/vector/commit/2c24f7e41a39363b23ac33a9a7108e3d0034e31e) - GitHub
* **deps**: Bump cargo-lock from 9.0.0 to 10.0.0 (#21518) [f2d5ea4](https://github.com/answerbook/vector/commit/f2d5ea44f1be4e85ed11e2f9dd1882687d0cdc81) - GitHub
* **deps**: Bump clap_complete from 4.5.33 to 4.5.35 in the patches group (#21606) [35fdfaf](https://github.com/answerbook/vector/commit/35fdfaff5c04896edc2df492deef1b1978d68a26) - GitHub
* **deps**: Bump clap-verbosity-flag from 2.2.3 to 3.0.0 in the clap group (#21859) [74f605b](https://github.com/answerbook/vector/commit/74f605b46b98c594453fbca6fbaa11092d3e3a5b) - GitHub
* **deps**: Bump databend-client from 0.21.1 to 0.22.2 (#21645) [cb177a2](https://github.com/answerbook/vector/commit/cb177a2da05bc1940d7b8ebea81566d2893616b0) - GitHub
* **deps**: Bump flate2 from 1.0.34 to 1.0.35 in the patches group (#21800) [9111569](https://github.com/answerbook/vector/commit/911156972f8d01ed030e5e4acc3eeebbfa396b80) - GitHub
* **deps**: Bump governor from 0.6.3 to 0.7.0 (#21577) [4c03f6c](https://github.com/answerbook/vector/commit/4c03f6c254a92a19f4d998cfac4e2affa6e9ba38) - GitHub
* **deps**: Bump libc from 0.2.159 to 0.2.160 (#21537) [5c11d09](https://github.com/answerbook/vector/commit/5c11d099ef3b46a32174e05cc76459292e27d158) - GitHub
* **deps**: Bump notify from 6.1.1 to 7.0.0 (#21646) [98e72c8](https://github.com/answerbook/vector/commit/98e72c82383a736aa0a538b5b0e7af4fd32d8953) - GitHub
* **deps**: Bump openssl from 0.10.66 to 0.10.67 (#21517) [7ebe30d](https://github.com/answerbook/vector/commit/7ebe30d2a395b067cd855e947e904c8c4d3259fc) - GitHub
* **deps**: Bump openssl-src from 300.3.2+3.3.2 to 300.4.1+3.4.0 (#21819) [9613dfd](https://github.com/answerbook/vector/commit/9613dfd6828561bfb747c292e42fb1adfc7d8560) - GitHub
* **deps**: Bump ordered-float from 4.3.0 to 4.4.0 (#21536) [849aa2d](https://github.com/answerbook/vector/commit/849aa2d0efad38558e2d56fbacd83ef2d2e0ba82) - GitHub
* **deps**: Bump ordered-float from 4.4.0 to 4.5.0 (#21700) [ec54dcc](https://github.com/answerbook/vector/commit/ec54dccdcc147c5e9e06e692b144e5c7b3a4cd70) - GitHub
* **deps**: Bump prettydiff from 0.7.0 to 0.8.0 (#21870) [6184dad](https://github.com/answerbook/vector/commit/6184dad1c9857b5fd959ae22ce9e8d106775ac8d) - GitHub
* **deps**: Bump proc-macro2 from 1.0.87 to 1.0.88 (#21532) [2883ca7](https://github.com/answerbook/vector/commit/2883ca7e10a0455e93ad0b92e5a94192be3e4989) - GitHub
* **deps**: Bump proptest-derive from 0.4.0 to 0.5.0 (#21690) [0660ad5](https://github.com/answerbook/vector/commit/0660ad5d44af116724a8e56f4b13bc54a7737cc1) - GitHub
* **deps**: Bump ratatui from 0.27.0 to 0.28.1 (#21501) [45b5224](https://github.com/answerbook/vector/commit/45b5224f3fe18683d109061edcf3760e879b80e2) - GitHub
* **deps**: Bump ratatui from 0.28.1 to 0.29.0 (#21701) [da0680c](https://github.com/answerbook/vector/commit/da0680c01597c03eb9c2306a731138843ddefa2a) - GitHub
* **deps**: Bump Rust version to 1.81.0 (#21509) [ca42966](https://github.com/answerbook/vector/commit/ca429665187786d47df46fe1cbc584a9bd0ca59a) - GitHub
* **deps**: Bump serde_json from 1.0.128 to 1.0.132 (#21565) [eb699ef](https://github.com/answerbook/vector/commit/eb699ef64dd40c3c2ce4d7366bae44e44b68b1f8) - GitHub
* **deps**: Bump syn from 2.0.79 to 2.0.82 (#21560) [5d517b9](https://github.com/answerbook/vector/commit/5d517b9f75c38a33670f5ecb1c6374cd9d0ac9e3) - GitHub
* **deps**: Bump tempfile from 3.13.0 to 3.14.0 (#21781) [954798d](https://github.com/answerbook/vector/commit/954798dfd1841411d5055b1aec9a2207e9847305) - GitHub
* **deps**: Bump the patches group across 1 directory with 10 updates (#21603) [f890a50](https://github.com/answerbook/vector/commit/f890a5028be00593d5ba59aebd06f0aa4d16617a) - GitHub
* **deps**: Bump the patches group across 1 directory with 2 updates (#21656) [93e4b78](https://github.com/answerbook/vector/commit/93e4b7828041bcd698088710c9278cd5e692b7cf) - GitHub
* **deps**: Bump the patches group across 1 directory with 3 updates (#21706) [68c2a19](https://github.com/answerbook/vector/commit/68c2a19b99fd4b1f297a022c781ecc5a8db3ff01) - GitHub
* **deps**: Bump the patches group across 1 directory with 3 updates (#21738) [6d1d521](https://github.com/answerbook/vector/commit/6d1d52116088dd41313e113aabb60ad3347ca96a) - GitHub
* **deps**: Bump the patches group across 1 directory with 3 updates (#21764) [43d47bf](https://github.com/answerbook/vector/commit/43d47bf0fa19c4ba8c7219bad5a21d7f1929c76a) - GitHub
* **deps**: Bump the patches group across 1 directory with 3 updates (#21790) [3463c9f](https://github.com/answerbook/vector/commit/3463c9fad44b0ff35d2336cbbf16a0022f7883b8) - GitHub
* **deps**: Bump the patches group across 1 directory with 6 updates (#21692) [a8e82dd](https://github.com/answerbook/vector/commit/a8e82dd71a38065d32db872e489e5dc4edb6dbc3) - GitHub
* **deps**: Bump the patches group across 1 directory with 6 updates (#21898) [daf08db](https://github.com/answerbook/vector/commit/daf08db13ffc91e831baa316f94aecc3c1226467) - GitHub
* **deps**: Bump the patches group across 1 directory with 8 updates (#21629) [9b540e8](https://github.com/answerbook/vector/commit/9b540e8adbbf6f492a58a2fd37449ce684f9a966) - GitHub
* **deps**: Bump the patches group with 2 updates (#21675) [e044856](https://github.com/answerbook/vector/commit/e044856e3073980262904ccc0a80d0d17ab0a3cc) - GitHub
* **deps**: Bump the patches group with 2 updates (#21838) [2864d54](https://github.com/answerbook/vector/commit/2864d5446a0b339f2e523424ea28d77a562785e1) - GitHub
* **deps**: Bump the patches group with 2 updates (#21858) [3d7f06d](https://github.com/answerbook/vector/commit/3d7f06dca693517900610a9533b61f848179c101) - GitHub
* **deps**: Bump the patches group with 2 updates (#21869) [0aad623](https://github.com/answerbook/vector/commit/0aad6230309ddde765164061ccba51b879cdb7f9) - GitHub
* **deps**: Bump the patches group with 3 updates (#21817) [d187ba8](https://github.com/answerbook/vector/commit/d187ba859e23cd32cc5f8dd81abbbea40e2bfd86) - GitHub
* **deps**: Bump tokio from 1.40.0 to 1.41.0 (#21589) [7b74ea8](https://github.com/answerbook/vector/commit/7b74ea857df75a462484b83120306208d43cbc9c) - GitHub
* **deps**: Bump twox-hash from 1.6.3 to 2.0.0 (#21566) [7985d45](https://github.com/answerbook/vector/commit/7985d4589ad3e9fdd5a290e30f4524ed1e1f9281) - GitHub
* **deps**: Bump uuid from 1.10.0 to 1.11.0 (#21535) [21ba31a](https://github.com/answerbook/vector/commit/21ba31ab5b3bc400003d0cd1ee80c04ccb52887f) - GitHub
* **deps**: bump vrl (#21774) [473ef43](https://github.com/answerbook/vector/commit/473ef43a881cd65add0850993129f1bce3b592a7) - GitHub
* **deps**: Bump vrl from `03cac27` to `a958c5d` (#21839) [8ef8925](https://github.com/answerbook/vector/commit/8ef8925770c61474d4bc9a88a9c27868d95a7bbc) - GitHub
* **deps**: Bump vrl from `3e1c7b0` to `d030427` (#21601) [0078939](https://github.com/answerbook/vector/commit/0078939e0ba08707d85511714c62cc9b643538d3) - GitHub
* **deps**: Bump vrl from `a07648f` to `c8c382b` (#21637) [d0252e2](https://github.com/answerbook/vector/commit/d0252e2163a26420d248ac8ec27f377c80136463) - GitHub
* **deps**: Bump vrl from `ac57e23` to `03cac27` (#21828) [572e8f4](https://github.com/answerbook/vector/commit/572e8f491056ab35691f204de22040c5fb0e51ff) - GitHub
* **deps**: Bump vrl from `d030427` to `a07648f` (#21608) [e2166a1](https://github.com/answerbook/vector/commit/e2166a1cb27fd14f056ea162f942cb9b4d119ab1) - GitHub
* **deps**: Bump vrl from `d5fb838` to `ac57e23` (#21809) [b36080f](https://github.com/answerbook/vector/commit/b36080fb384bf7aa2dfc3ef12e4e0238f98371a8) - GitHub
* **deps**: Bump vrl from `dc0311d` to `3e1c7b0` (#21542) [90b32f8](https://github.com/answerbook/vector/commit/90b32f864f50c6440873613275d593423bf109ce) - GitHub
* **deps**: bump vrl@2.0.4 [skip lint] [331a380](https://github.com/answerbook/vector/commit/331a380b018d23721761a76b747f4c0094344cf1) - Mike Del Tito [LOG-22128](https://logdna.atlassian.net/browse/LOG-22128)
* **deps**: Downgrade smp to 0.16.1 (#21522) [c0375c0](https://github.com/answerbook/vector/commit/c0375c0a37d3de9c8f71d512ee8e96a677fa9717) - GitHub
* **deps**: Drop use of `infer` crate (#21623) [29d58c9](https://github.com/answerbook/vector/commit/29d58c919acfefc53f19a08ae4eab9c0e4da46d9) - GitHub
* **deps**: Expose `vrl` through `vector-lib` (#21491) [6f352ff](https://github.com/answerbook/vector/commit/6f352ff8a350d7d8258fbb52b9ff83c2adaa3465) - GitHub
* **deps**: Handle recent GitHub Actions deprecations (#21528) [624fa1a](https://github.com/answerbook/vector/commit/624fa1a0a7b21161461669156b01feb3082f8fe4) - GitHub
* **deps**: make snafu a workspace dependency (#21798) [9f243aa](https://github.com/answerbook/vector/commit/9f243aade7f631b564164d9ec7e68d6f79ed23b1) - GitHub
* **deps**: Properly hand off the `proptest` feature to `vrl` (#21574) [75d59e9](https://github.com/answerbook/vector/commit/75d59e957a716622fec2cb5590b5d71cbb659a52) - GitHub
* **deps**: Update VRL to c69a52e67 and mlua to 0.10.0 (#21670) [b22b732](https://github.com/answerbook/vector/commit/b22b732b584fb6636b1d891b8db4af621ce4a94e) - GitHub
* **deps**: Upgrade cargo-deny to latest (#21761) [c2abea9](https://github.com/answerbook/vector/commit/c2abea9b7875257017ede863fb26ffb672116514) - GitHub
* **deps**: Upgrade check-spelling to 0.0.23 (#21736) [bdfd146](https://github.com/answerbook/vector/commit/bdfd14661e82cffc3ed6efafe0aa379f14e0d891) - GitHub
* **dev**: Add configuration for aqua to manage tooling dependencies (#18020) [3c26a50](https://github.com/answerbook/vector/commit/3c26a506d70d4ed576f9acf520efc37c54bb6634) - GitHub
* **dev**: delete 'configurable_package_name_hack' and refactor (#21826) [3a45992](https://github.com/answerbook/vector/commit/3a45992c23a51ffd7329df87d3ab418062e803ba) - GitHub
* **dev**: delete transforms-pipelines feature (#21796) [9ae2497](https://github.com/answerbook/vector/commit/9ae24976d0c010396c0c243accd8a2c346dfac42) - GitHub
* **dev**: Gate additional parameters in elasticsearch sink (#21768) [a7acdfe](https://github.com/answerbook/vector/commit/a7acdfe19c7b913accb03a75260c616b841fe72a) - GitHub
* **dev**: update cargo lock (#21744) [530d02d](https://github.com/answerbook/vector/commit/530d02df6813c0353ef74dc32d49967e5655a1c3) - GitHub
* **dev**: update Cargo.lock (#21679) [b1e93ee](https://github.com/answerbook/vector/commit/b1e93ee6dd103ed423de098e53a30ab7bbee997d) - GitHub
* **dev**: update datadog-signing-keys recommended version (#21712) [c394bfc](https://github.com/answerbook/vector/commit/c394bfc4fc614e4bcf8ff991de526dbcd13bb157) - GitHub
* **docs**: Fix link in DEPRECATIONS.md (#21524) [334c1c0](https://github.com/answerbook/vector/commit/334c1c04b4b039352082491e990a5cc0c47c3efb) - GitHub
* **external docs**: improve `route` transform docs (#21635) [456e98e](https://github.com/answerbook/vector/commit/456e98e34393bceb12f986ee3c0fc9affac65020) - GitHub
* **external docs**: improve vrl.dev tutorial (#21619) [57837b9](https://github.com/answerbook/vector/commit/57837b96cc3f063a482111373e6921462828f75c) - GitHub
* **external docs**: update support and community docs (#21612) [099ca7f](https://github.com/answerbook/vector/commit/099ca7f02654bd0b5ab95bef35e97f059961076b) - GitHub
* format markdown tables (#21498) [53e7df2](https://github.com/answerbook/vector/commit/53e7df2d9c2058e5fd655e2375a671d77e0957f5) - GitHub
* **javascript website**: bump ts package (#21620) [01a562a](https://github.com/answerbook/vector/commit/01a562a71f7a7412e5812da3d65862f3b788fd99) - GitHub
* **releasing**: Bump k8s manifests to v0.37.0 of the chart (#21569) [22a51cd](https://github.com/answerbook/vector/commit/22a51cddde5f2de950a67bc89956070b3b6cd89d) - GitHub
* **releasing**: Prepare v0.42.0 release [fc6883f](https://github.com/answerbook/vector/commit/fc6883fee7c449d4749ea884dde7f9062aa6d2f2) - Jesse Szwedko
* **releasing**: Prepare v0.43.0 (#21906) [88e017f](https://github.com/answerbook/vector/commit/88e017ff11bf7e8d688b4cbbe4a9831d52a27022) - Pavlos Rontidis
* **releasing**: Update minor-release template with a few tweaks (#21526) [cd8039d](https://github.com/answerbook/vector/commit/cd8039d392b23049f577a427112ff7d97e56ea4b) - GitHub
* remove unnecessary string hashes (#21559) [a919568](https://github.com/answerbook/vector/commit/a91956819d78d166efb43ae4abad597b741d051d) - GitHub
* upgrade `typesense-sync` package (#21572) [dd39ab3](https://github.com/answerbook/vector/commit/dd39ab35290316e34cbeebba8e1b26d455bc9d0a) - GitHub
* **website**: remove invalid link (#21848) [0a65b56](https://github.com/answerbook/vector/commit/0a65b569b6f1fb9676305833f2835085a3c0b07d) - GitHub
* **website**: update community page (#21693) [9d74d12](https://github.com/answerbook/vector/commit/9d74d12274abd16a90d04cf3a7308675c1c3d3ac) - GitHub


### Features

* **chronicle-sink**: add support for compression to Google Chronicle sink (#21272) [17466c6](https://github.com/answerbook/vector/commit/17466c684bc6d3b0356c976e9639f9b05d306769) - GitHub
* **ci**: regression detection overhaul (#21567) [8c4e276](https://github.com/answerbook/vector/commit/8c4e27651f554db8c543bc29d184d03a7e5b69e2) - GitHub
* **cli**: add support for poll watcher (#21290) [b3c8dc8](https://github.com/answerbook/vector/commit/b3c8dc88fcc43dcf14cab53167f6e005d07172f8) - GitHub
* **codecs**: Add CEF encoder (#17389) [ac1e975](https://github.com/answerbook/vector/commit/ac1e975d109e4ab575e2acb2f3766aa8084c8ea3) - GitHub
* **codecs**: chunked gelf decoder decompression support (#21816) [5c7db96](https://github.com/answerbook/vector/commit/5c7db961cf6aecbf70a188810d3d26d19c2fb805) - GitHub
* **codecs**: Implement chunked GELF decoding (#20859) [07e2eae](https://github.com/answerbook/vector/commit/07e2eae75ad6c6f9c75e5be99a23c1c52ac1e3fc) - GitHub
* **config**: support loading secrets from files and directories (#21282) [a8c0b6e](https://github.com/answerbook/vector/commit/a8c0b6ee596999b28fb0bb136fdc55dce7eb361d) - GitHub
* **elasticsearch sink**: Support Amazon OpenSearch Serverless (#21676) [7fb5dad](https://github.com/answerbook/vector/commit/7fb5dad7752893929f55144d796f468ad2f1a12a) - GitHub
* **exclusive_route transform**: implements new transform (#21707) [98b63cf](https://github.com/answerbook/vector/commit/98b63cf75e52b02e5d6fb3bc8b7c65831c5cda8f) - GitHub
* **honeycomb sink**: Support compression (#21889) [58a4055](https://github.com/answerbook/vector/commit/58a4055f8b7a4a90b239eead3df40dc896a1bb2a) - GitHub
* **host_metrics source**: Implement process collection for host metrics (#21791) [798f300](https://github.com/answerbook/vector/commit/798f30005b436abdf0d366b8856771f055b50dea) - GitHub
* **internal**: Add fallback key_prefix for object storage destinations (#21770) [6ac72ba](https://github.com/answerbook/vector/commit/6ac72ba6a6de9ef4dab33dc2b00301cf4bf89986) - GitHub
* **internal**: Add VECTOR_HOSTNAME env variable (#21789) [1f02dfb](https://github.com/answerbook/vector/commit/1f02dfb081327382da6f4ad9211605fbea504dfe) - GitHub
* **opentelemetry sink**: new sink (#21866) [2e606e6](https://github.com/answerbook/vector/commit/2e606e6512fad8b595f93419c9ad9d345eea72c5) - GitHub
* **opentelemetry source**: add support for enriching logs with HTTP headers (#21674) [872d0b5](https://github.com/answerbook/vector/commit/872d0b5d4ac1cb591341da94a4acf19145ecbeae) - GitHub
* **sample transform**: add sample_rate_key config option (#21283) [08bf15a](https://github.com/answerbook/vector/commit/08bf15a51a6f54741140de164b06ae0219b9a4b7) - GitHub
* **transform**: add support for loading and joining an array of vrl files in remap (#21497) [1e11b92](https://github.com/answerbook/vector/commit/1e11b92a5b00d0a4169e9e396ee3991235815bf4) - GitHub


### Miscellaneous

* Merge pull request #692 from answerbook/feature/LOG-22128 [42b8815](https://github.com/answerbook/vector/commit/42b881583a2940f76041df156aa786d30598559e) - GitHub [LOG-22128](https://logdna.atlassian.net/browse/LOG-22128)
* Merge remote-tracking branch 'origin/master' into feature/LOG-22128 [a532449](https://github.com/answerbook/vector/commit/a532449881dc02e8f4de708d473c18cefb16017d) - Darin Spivey [LOG-22128](https://logdna.atlassian.net/browse/LOG-22128)
* Merge upstream 'v0.43.0' into feature/LOG-22128 [2ec32a8](https://github.com/answerbook/vector/commit/2ec32a8b0d5fb702f27fcea3416a09b996ea385c) - Darin Spivey [LOG-22128](https://logdna.atlassian.net/browse/LOG-22128) [LOG-22128](https://logdna.atlassian.net/browse/LOG-22128)
* Revert "chore(ci): Bump check-spelling/check-spelling from 0.0.21 to 0.0.24" (#21732) [a0e5b97](https://github.com/answerbook/vector/commit/a0e5b971fb3a36c50fbb4def122d70dac7112208) - GitHub
* Update PULL_REQUEST_TEMPLATE.md (#21724) [acea5ae](https://github.com/answerbook/vector/commit/acea5ae0fdaa5ffd3c90706b07bd34a3dd93f371) - GitHub
* **azure_blob sink, gcp_cloud_storage sink**: Note transparent decompression (#21814) [983a993](https://github.com/answerbook/vector/commit/983a9937ac5fc24db0203eec0390550351ec2cbe) - GitHub
* **azure_blob sink**: Clarify SAS connection_string support  (#21611) [b242e4a](https://github.com/answerbook/vector/commit/b242e4aacc4bde40c41f3564e12781646f67a3a5) - GitHub
* **components**: Add customizable connection retry options for Pulsar client in Pulsar sink (#21245) [baf6a55](https://github.com/answerbook/vector/commit/baf6a555051ead0890801920fe88b6f86cd972ae) - GitHub
* **config**: Document limitation of log namespacing with disk buffers (#21813) [9e97385](https://github.com/answerbook/vector/commit/9e973857738b5e3bce1fc04d0b5dd9090c4afe63) - GitHub
* **config**: Update wrapped_json.yaml example (#21746) [85e2f54](https://github.com/answerbook/vector/commit/85e2f547580b06bbb306da84de8bc8d07f651b44) - GitHub
* **core**: fix MetricsKind typo (#21573) [4d1f3fd](https://github.com/answerbook/vector/commit/4d1f3fde4a2ec42165e3ffd062fd28e3ead83b16) - GitHub
* **dev**: document how to update licenses (#21719) [c6357a1](https://github.com/answerbook/vector/commit/c6357a1cf4bf88aaf361ee9c3df4f98cb2507594) - GitHub
* **dnstap source**: add EDE code 30 to known EDE codes (#21743) [246576b](https://github.com/answerbook/vector/commit/246576bf58f4b3a592a9aa8944b1a3e9baf36a62) - GitHub
* **elasticsearch sink**: Add update support to bulk action (#21860) [fd9166b](https://github.com/answerbook/vector/commit/fd9166b8db11a85fec2d5000eb9f7b537f91d18d) - GitHub
* **external**: fix route config test (#21745) [0827ed9](https://github.com/answerbook/vector/commit/0827ed9f3344da51ee322ec833f68bf187549f7d) - GitHub
* **external**: remove incorrect failure reason for parse_regex_all fallibility (#21884) [c3d91af](https://github.com/answerbook/vector/commit/c3d91af5288cc4d10806f7724bf7ba0401ba2b7e) - GitHub
* **external**: timestamp clarification (#21769) [b1e8f46](https://github.com/answerbook/vector/commit/b1e8f46ace516829ff6d95457b42449f5ecdbbd4) - GitHub
* **external**: tiny improvement to changelog README (#21663) [c20d358](https://github.com/answerbook/vector/commit/c20d358805ef86fbaee4c92bfcdf0f4060b08e9f) - GitHub
* **external**: Update CONTRIBUTING.md (#21730) [ffa06ad](https://github.com/answerbook/vector/commit/ffa06ad376cd6fe2657d083df01ff4ccc840e8f6) - GitHub
* **greptimedb_logs sink**: provide a default value for greptimedb logs pipeline_name (#21739) [a192aa7](https://github.com/answerbook/vector/commit/a192aa7dae1fdfc51c9787cb0aa39fcda87ef945) - GitHub
* **http provider**: Add automatic bearer token acquisition in http-client [version 2] (#21583) [fb9c5c1](https://github.com/answerbook/vector/commit/fb9c5c1bb21507b9e79f465463d6a9a12c8be195) - GitHub
* **http sink**: Retrying the HTTP sink in case of 404s and request timeouts (#21457) [e3cd143](https://github.com/answerbook/vector/commit/e3cd14335fc80c87a25f525a130c697469d63822) - GitHub
* **kafka source, kafka sink**: include kafka source in `librdkafka` section (#21760) [f799d49](https://github.com/answerbook/vector/commit/f799d49aff1b8ebabd4e58beb0d760eef9405aff) - GitHub
* **kubernetes_logs source**: support scraping metadata from Kubernetes log files on Windows (#21505) [241b2f1](https://github.com/answerbook/vector/commit/241b2f1b6dd5a5a0c16a714696ae3bc4722815d7) - GitHub
* **sample transform**: add stratified sampling capability (#21274) [448ce64](https://github.com/answerbook/vector/commit/448ce648bec90e882d20eebda910347c261b5735) - GitHub
* **static_metrics source**: Fix example configuration (#21636) [d90a95c](https://github.com/answerbook/vector/commit/d90a95cb1919fdc870e45c17811c12877478e314) - GitHub
* **vector sink**: Added proxy option to Vector sink (#21609) [e0b8049](https://github.com/answerbook/vector/commit/e0b804996a7d899962ce6cc8df4d9e4861f1f77f) - GitHub
* **vrl**: document punycode as an IDN function (#21734) [aa35e35](https://github.com/answerbook/vector/commit/aa35e35ad9a7d578a130ac231a6f6b178d85fe3b) - GitHub
* **vrl**: Update docs for new AES-SIV encryption/decryption types available in latest VRL. (#21659) [21e1b82](https://github.com/answerbook/vector/commit/21e1b8247ae7c8a17589f61d5859e76ae26ead10) - GitHub
