...
pub use vector_core::{
    ...
    latency, metric_tags, metrics, mezmo, partition, quantiles, register, samples, schema, serde,
    sink, source, source_sender, tcp, tls, transform, update_counter, usage_metrics,
};
